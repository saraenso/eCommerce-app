function e(e,t,r,n){Object.defineProperty(e,t,{get:r,set:n,enumerable:!0,configurable:!0})}var t="undefined"!=typeof globalThis?globalThis:"undefined"!=typeof self?self:"undefined"!=typeof window?window:"undefined"!=typeof global?global:{},r={},n={},i=t.parcelRequire716c;null==i&&((i=function(e){if(e in r)return r[e].exports;if(e in n){var t=n[e];delete n[e];var i={id:e,exports:{}};return r[e]=i,t.call(i.exports,i,i.exports),i.exports}var s=Error("Cannot find module '"+e+"'");throw s.code="MODULE_NOT_FOUND",s}).register=function(e,t){n[e]=t},t.parcelRequire716c=i),i.register("CdASA",function(t,r){e(t.exports,"default",function(){return l}),i("fEUPL");var n=i("gl50r");i("kZp87");var s=i("70Waa"),a=i("21L7G");let o={apiKey:"AIzaSyBF4A_qZPX5HB-mv8rRXt0DTdCqLGT68ac",authDomain:"ecommerce-app-feb0d.firebaseapp.com",projectId:"ecommerce-app-feb0d",storageBucket:"ecommerce-app-feb0d.appspot.com",messagingSenderId:"803168511954",appId:"1:803168511954:web:714cb8e9e339617c53ca0b"};var l=function(){let e=(0,n.initializeApp)(o),t=(0,s.getFirestore)(e);return{getData:async function(){let e=(0,s.collection)(t,a.ITEMS_STORAGE_KEY),r=(0,s.query)(e,(0,s.orderBy)("createdAt")),n=await (0,s.getDocs)(r),i=[];return n.forEach(e=>{i.push({id:e.id,model:e.data().model,quantity:e.data().quantity,series:e.data().series,cost:e.data().price.cost,currency:e.data().price.currency,description:{shortDescription:e.data().description.shortDescription,longDescription:e.data().description.longDescription,miniDescription:e.data().description.miniDescription},rating:e.data().rating,imageURL:e.data().imageURL,createdAt:e.data().createdAt})}),i},addToOrders:async function(e){try{let r=(0,s.collection)(t,a.ORDERS_STORAGE_KEY),n=(0,s.query)(r,(0,s.where)("id","==",e.id)),i=await (0,s.getDocs)(n);if(console.log("Success add to orders"),i.empty){let t=(0,s.doc)(r,e.id);await (0,s.setDoc)(t,{id:e.id,quantity:1,model:e.model,series:e.series,cost:e.cost,currency:e.currency,description:{shortDescription:e.description.shortDescription,longDescription:e.description.longDescription,miniDescription:e.description.miniDescription},rating:e.rating,imageURL:e.imageURL,createdAt:(0,s.serverTimestamp)()})}else{let e=i.docs[0],r=e.data().quantity+1;await (0,s.updateDoc)((0,s.doc)(t,a.ORDERS_STORAGE_KEY,e.id),{quantity:r})}}catch(e){console.error("Error adding/updating order:",e)}},getOrders:async function(){let e=(0,s.collection)(t,a.ORDERS_STORAGE_KEY),r=(0,s.query)(e,(0,s.orderBy)("createdAt")),n=await (0,s.getDocs)(r),i=[];return n.forEach(e=>{i.push({id:e.id,model:e.data().model,quantity:e.data().quantity,series:e.data().series,cost:e.data().cost,currency:e.data().currency,description:{shortDescription:e.data().description.shortDescription,longDescription:e.data().description.longDescription,miniDescription:e.data().description.miniDescription},rating:e.data().rating,imageURL:e.data().imageURL,createdAt:e.data().createdAt})}),console.log("Orders from Firestore:",i),i},clearOrders:async function(e){try{let r=(0,s.writeBatch)(t);e.forEach(e=>{let n=(0,s.doc)(t,a.ORDERS_STORAGE_KEY,e.id);r.delete(n)}),await r.commit(),console.log("Successfully cleared orders.")}catch(e){console.error("Error clearing orders:",e)}},updateOrderQuantity:async function(e,r){try{let n=(0,s.collection)(t,a.ORDERS_STORAGE_KEY),i=(0,s.query)(n,(0,s.where)("id","==",e)),o=await (0,s.getDocs)(i);if(o.empty)console.log(`Item with ID ${e} not found in orders.`);else{let n=(0,s.doc)(t,a.ORDERS_STORAGE_KEY,e),i=o.docs[0].data();"increase"===r?(await (0,s.updateDoc)(n,{quantity:i.quantity+1}),console.log(`Increased quantity of item with ID ${e} by 1.`)):"decrease"===r&&i.quantity>1?(await (0,s.updateDoc)(n,{quantity:i.quantity-1}),console.log(`Decreased quantity of item with ID ${e} by 1.`)):console.log(`Can't decrease the quantity of item with ID ${e} below 1.`)}}catch(e){console.error("Error updating order quantity:",e)}},getItemById:async function(e){let r=(0,s.doc)(t,a.ITEMS_STORAGE_KEY,e),n=await (0,s.getDoc)(r);if(!n.exists())return null;{let e=n.data();return{id:n.id,model:e.model,quantity:e.quantity,series:e.series,cost:e.price.cost,currency:e.price.currency,description:{shortDescription:e.description.shortDescription,longDescription:e.description.longDescription,miniDescription:e.description.miniDescription},rating:e.rating,imageURL:e.imageURL,createdAt:e.createdAt}}},addCompletedOrder:async function(e){try{let r=(0,s.collection)(t,a.COMPLETEDORDERS_STORAGE_KEY);await (0,s.setDoc)((0,s.doc)(r),{customerName:e.customerName,customerAddress:e.customerAddress,customerCity:e.customerCity,customerTelephone:e.customerTelephone,items:e.items,totalGoodsSum:e.totalGoodsSum,totalAmount:e.totalAmount,payMethod:e.payMethod,deliveryCost:6.99,currency:e.items[0].currency,createdAt:(0,s.serverTimestamp)()}),console.log("Successfully added completed order to Firestore.")}catch(e){console.error("Error adding completed order:",e)}},getCompletedOrders:async function(){try{let e=(0,s.collection)(t,a.COMPLETEDORDERS_STORAGE_KEY),r=(0,s.query)(e,(0,s.orderBy)("createdAt")),n=await (0,s.getDocs)(r),i=[];return n.forEach(e=>{i.push({id:e.id,customerName:e.data().customerName,customerAddress:e.data().customerAddress,customerCity:e.data().customerCity,customerTelephone:e.data().customerTelephone,items:e.data().items,totalGoodsSum:e.data().totalGoodsSum,totalAmount:e.data().totalAmount,payMethod:e.data().payMethod,deliveryCost:e.data().deliveryCost,currency:e.data().currency,createdAt:e.data().createdAt})}),console.log("Completed orders from Firestore:",i),i;// Возвращаем массив с завершенными заказами
}catch(e){console.error("Error fetching completed orders:",e)}},db:t}}}),i.register("fEUPL",function(t,r){e(t.exports,"initializeApp",function(){return i("gl50r").initializeApp}),e(t.exports,"registerVersion",function(){return i("gl50r").registerVersion}),/**
 * @license
 ...
 */(0,i("gl50r").registerVersion)("firebase","10.3.0","app")}),i.register("gl50r",function(t,r){e(t.exports,"_registerComponent",function(){return m}),e(t.exports,"_getProvider",function(){return y}),e(t.exports,"_removeServiceInstance",function(){return v}),e(t.exports,"SDK_VERSION",function(){return _}),e(t.exports,"initializeApp",function(){return b}),e(t.exports,"getApp",function(){return T}),e(t.exports,"registerVersion",function(){return I});var n=i("b2k2G"),s=i("j3yQb"),a=i("dAPL1"),o=i("2NbkD");/**
 * @license
...
let s=null!==(i=f[e])&&void 0!==i?i:e;r&&(s+=`-${r}`);let a=s.match(/\s|\//),o=t.match(/\s|\//);if(a||o){let e=[`Unable to register library "${s}" with version "${t}":`];a&&e.push(`library name "${s}" contains illegal characters (whitespace or "/")`),a&&o&&e.push("and"),o&&e.push(`version name "${t}" contains illegal characters (whitespace or "/")`),c.warn(e.join(" "));return}m(new n.Component(`${s}-version`,()=>({library:s,version:t}),"VERSION"/* ComponentType.VERSION */))}let S="firebase-heartbeat-store",A=null;function C(){return A||(A=(0,o.openDB)("firebase-heartbeat-database",1,{upgrade:(e,t)=>{0===t&&e.createObjectStore(S)}}).catch(e=>{throw w.create("idb-open"/* AppError.IDB_OPEN */,{originalErrorMessage:e.message})})),A}async function D(e){try{let t=await C(),r=await t.transaction(S).objectStore(S).get(k(e));return r}catch(e){if(e instanceof a.FirebaseError)c.warn(e.message);else{let t=w.create("idb-get"/* AppError.IDB_GET */,{originalErrorMessage:null==e?void 0:e.message});c.warn(t.message)}}}async function N(e,t){try{let r=await C(),n=r.transaction(S,"readwrite"),i=n.objectStore(S);await i.put(t,k(e)),await n.done}catch(e){if(e instanceof a.FirebaseError)c.warn(e.message);else{let t=w.create("idb-set"/* AppError.IDB_WRITE */,{originalErrorMessage:null==e?void 0:e.message});c.warn(t.message)}}}function k(e){return`${e.name}!${e.options.appId}`}class x{constructor(e){this.container=e,/**
     ...
     */async triggerHeartbeat(){let e=this.container.getProvider("platform-logger").getImmediate(),t=e.getPlatformInfoString(),r=R();return(// Do not store a heartbeat if one is already stored for this day
...
if(null===this._heartbeatsCache&&await this._heartbeatsCachePromise,null===this._heartbeatsCache||0===this._heartbeatsCache.heartbeats.length)return"";let e=R(),{heartbeatsToSend:t,unsentEntries:r}=function(e,t=1024){// Heartbeats grouped by user agent in the standard format to be sent in
// the header.
...
await this._storage.overwrite(this._heartbeatsCache)):(this._heartbeatsCache.heartbeats=[],this._storage.overwrite(this._heartbeatsCache)),n)}}function R(){let e=new Date;// Returns date format 'YYYY-MM-DD'
...
return(0,a.base64urlEncodeWithoutPadding)(JSON.stringify({version:2,heartbeats:e})).length}m(new n.Component("platform-logger",e=>new l(e),"PRIVATE"/* ComponentType.PRIVATE */)),m(new n.Component("heartbeat",e=>new x(e),"PRIVATE"/* ComponentType.PRIVATE */)),// Register `app` package.
...
I("fire-js","")}),i.register("b2k2G",function(t,r){e(t.exports,"Component",function(){return s}),e(t.exports,"ComponentContainer",function(){return l});var n=i("dAPL1");/**
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function k(e){return e&&e._delegate?e._delegate:e}}),i.register("4Dxou",function(e,t){// shim for using process in browser
...
return n&&(a=a.index(t.shift())),(await Promise.all([a[r](...t),i&&s.done]))[0]};return l.set(t,s),s}(0,n.r)(e=>({...e,get:(t,r,n)=>u(t,r)||e.get(t,r,n),has:(t,r)=>!!u(t,r)||e.has(t,r)}))}),i.register("b06tL",function(t,r){let n,i;e(t.exports,"w",function(){return f}),e(t.exports,"r",function(){return d});let s=(e,t)=>t.some(t=>e instanceof t),a=new WeakMap,o=new WeakMap,l=new WeakMap,u=new WeakMap,h=new WeakMap,c={get(e,t,r){if(e instanceof IDBTransaction){// Special handling for transaction.done.
...
o.set(e,t)}(t),s(t,n||(n=[IDBDatabase,IDBObjectStore,IDBIndex,IDBCursor,IDBTransaction])))?new Proxy(t,c):t;return r!==e&&(u.set(e,r),h.set(r,e)),r}let p=e=>h.get(e)}),i.register("kZp87",function(t,r){e(t.exports,"collection",function(){return i("70Waa").collection}),e(t.exports,"doc",function(){return i("70Waa").doc}),e(t.exports,"getDoc",function(){return i("70Waa").getDoc}),e(t.exports,"getDocs",function(){return i("70Waa").getDocs}),e(t.exports,"getFirestore",function(){return i("70Waa").getFirestore}),e(t.exports,"orderBy",function(){return i("70Waa").orderBy}),e(t.exports,"query",function(){return i("70Waa").query}),e(t.exports,"serverTimestamp",function(){return i("70Waa").serverTimestamp}),e(t.exports,"setDoc",function(){return i("70Waa").setDoc}),e(t.exports,"updateDoc",function(){return i("70Waa").updateDoc}),e(t.exports,"where",function(){return i("70Waa").where}),e(t.exports,"writeBatch",function(){return i("70Waa").writeBatch}),i("70Waa")}),i.register("70Waa",function(t,r){e(t.exports,"collection",function(){return iw}),e(t.exports,"doc",function(){return iE}),e(t.exports,"getFirestore",function(){return iT}),e(t.exports,"query",function(){return i2}),e(t.exports,"where",function(){return i4}),e(t.exports,"orderBy",function(){return i3}),e(t.exports,"getDoc",function(){return sl}),e(t.exports,"getDocs",function(){return sh}),e(t.exports,"setDoc",function(){return sc}),e(t.exports,"updateDoc",function(){return sd}),e(t.exports,"serverTimestamp",function(){return sm}),e(t.exports,"writeBatch",function(){return sy});var n,s,a=i("gl50r"),o=i("b2k2G"),l=i("j3yQb"),u=i("dAPL1"),h=i("aplQ0");i("4Dxou");let c="@firebase/firestore";/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * from all views.
 */class ex{constructor(e,t,r,n,i,s,a){this.key=e,this.documentType=t,this.version=r,this.readTime=n,this.createTime=i,this.data=s,this.documentState=a}/**
     ...
     * given version.
     */static newFoundDocument(e,t,r,n){return new ex(e,1/* DocumentType.FOUND_DOCUMENT */,/* version */t,/* readTime */P.min(),/* createTime */r,n,0/* DocumentState.SYNCED */)}/** Creates a new document that is known to not exist at the given version. */static newNoDocument(e,t){return new ex(e,2/* DocumentType.NO_DOCUMENT */,/* version */t,/* readTime */P.min(),/* createTime */P.min(),ek.empty(),0/* DocumentState.SYNCED */)}/**
 ...
 */class eR{constructor(e,t){this.position=e,this.inclusive=t}}function eL(e,t,r){let n=0;for(let i=0;i<e.position.length;i++){let s=t[i],a=e.position[i];if(n=s.field.isKeyField()?q.comparator(q.fromName(a.referenceValue),r.key):ew(a,r.data.field(s.field)),"desc"/* Direction.DESCENDING */===s.dir&&(n*=-1),0!==n)break}return n}/**
...
let r=e.endAt?new eR(e.endAt.position,e.endAt.inclusive):null,n=e.startAt?new eR(e.startAt.position,e.startAt.inclusive):null;// Now return as a LimitType.First query.
 ...
 */function tR(e,t,r,n){return e instanceof tO?function(e,t,r,n){if(!tN(e.precondition,t))// caused a name collision).
...
for(let r of this.baseMutations)r.key.isEqual(e.key)&&(t=tR(r,e,t,this.localWriteTime));// Second, apply all user-provided mutations.
for(let r of this.mutations)r.key.isEqual(e.key)&&(t=tR(r,e,t,this.localWriteTime));return t}/**
...
// queries.
let e=new q(i.path);this.je(t,e,ex.newNoDocument(e,P.min()))}else 1===r||E()}else{let n=this.tt(t);// Existence filter mismatch. Mark the documents as being in limbo, and
...
let t=new q(i.target.path);null!==this.$e.get(t)||this.ut(n,t)||this.je(n,t,ex.newNoDocument(t,e))}r.Fe&&(t.set(n,r.xe()),r.Oe())}});let r=td();// We extract the set of limbo-only document updates as the GC logic
 ...
 */class rI{constructor(e,t,r,n){this.remoteDocumentCache=e,this.mutationQueue=t,this.documentOverlayCache=r,this.indexManager=n}/**
     ...
     * state for it.
     */getDocument(e,t){let r=null;return this.documentOverlayCache.getOverlay(e,t).next(n=>(r=n,this.remoteDocumentCache.getEntry(e,t))).next(e=>(null!==r&&tR(r.mutation,e,en.empty(),M.now()),e))}/**
...
n.has(t.key)&&(void 0===a||a.mutation instanceof tM)?i=i.insert(t.key,t):void 0!==a?(s.set(t.key,a.mutation.getFieldMask()),tR(a.mutation,t,a.mutation.getFieldMask(),M.now())):// Using EMPTY to indicate there is no overlay for the document.
...
// already saved.
for(;a.hasNext();){let n=a.getNext(),o=n.key,l=n.value,u=tu();l.forEach(e=>{if(!i.has(e)){let n=tx(t.get(e),r.get(e));null!==n&&u.set(e,n),i=i.add(e)}}),s.push(this.documentOverlayCache.saveOverlays(e,o,u))}return K.waitFor(s)}).next(()=>r)}/**
...
n.forEach((t,r)=>{let n=r.getKey();null===e.get(n)&&(e=e.insert(n,ex.newInvalidDocument(n)))});// Apply the overlays and match against the query.
let r=to();return e.forEach((e,i)=>{let s=n.get(e);void 0!==s&&tR(s.mutation,i,en.empty(),M.now()),tr(t,i)&&(r=r.insert(e,i))}),r})}}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
...
return new rx(this)}getSize(e){return K.resolve(this.size)}}/**
 ...
 */class rx extends rb{constructor(e){super(),this.ar=e}applyChanges(e){let t=[];return this.changes.forEach((r,n)=>{n.isValidDocument()?t.push(this.ar.addEntry(e,n)):this.ar.removeEntry(r)}),K.waitFor(t)}getFromCache(e,t){return this.ar.getEntry(e,t)}getAllFromCache(e,t){return this.ar.getEntries(e,t)}}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class rR{constructor(e){this.persistence=e,/**
 ...
 */class nD{constructor(){this.N_=void 0,this.listeners=[]}}class nN{constructor(){this.queries=new ti(e=>te(e),e8),this.onlineState="Unknown"/* OnlineState.Unknown */,this.B_=new Set}}async function nk(e,t){let r=t.query,n=!1,i=e.queries.get(r);if(i||(n=!0,i=new nD),n)try{i.N_=await e.onListen(r)}catch(r){let e=nI(r,`Initialization of query '${tt(t.query)}' failed`);return void t.onError(e)}e.queries.set(r,i),i.listeners.push(t),t.L_(e.onlineState),i.N_&&t.k_(i.N_)&&nO(e)}async function nx(e,t){let r=t.query,n=!1,i=e.queries.get(r);if(i){let e=i.listeners.indexOf(t);e>=0&&(i.listeners.splice(e,1),n=0===i.listeners.length)}if(n)return e.queries.delete(r),e.onUnlisten(r)}function nR(e,t){let r=!1;for(let n of t){let t=n.query,i=e.queries.get(t);if(i){for(let e of i.listeners)e.k_(n)&&(r=!0);i.N_=n}}r&&nO(e)}function nL(e,t,r){let n=e.queries.get(t);if(n)for(let e of n.listeners)e.onError(r);// Remove all listeners. NOTE: We don't need to call syncEngine.unlisten()
// after an error.
 ...
 */async function nj(e,t){var r,n;let i,s;let a=(e.remoteStore.remoteSyncer.applyRemoteEvent=nG.bind(null,e),e.remoteStore.remoteSyncer.getRemoteKeysForTarget=n6.bind(null,e),e.remoteStore.remoteSyncer.rejectListen=nQ.bind(null,e),e.da.s_=nR.bind(null,e.eventManager),e.da.Da=nL.bind(null,e.eventManager),e),o=a.Aa.get(t);if(o)// already exists when EventManager calls us for the first time. This
...
r=r.insert(i,ex.newNoDocument(i,P.min()));let n=td().add(i),s=new tX(P.min(),/* targetChanges= */new Map,/* targetMismatches= */new J(L),r,n);await nG(e,s),// We only remove it from bookkeeping after we successfully applied the
...
// performing validation.
r=(0,u.getModularInstance)(r);let n=a.Eu(t);if(r instanceof iV)h.push(t);else{let e=ij(r,n);null!=e&&(h.push(t),c.set(t,e))}}let d=new en(h);return new iR(c,d,a.fieldTransforms)}/**
 ...
 */function sl(e){e=id(e,iy);let t=id(e.firestore,ib);return(function(e,t,r={}){let n=new T;return e.asyncQueue.enqueueAndForget(async()=>(function(e,t,r,n,i){var s;let a=new n7({next:s=>{// Remove query first before passing event to user to avoid
    ...
    t.enqueueAndForget(()=>nx(e,o));let a=s.docs.has(r);!a&&s.fromCache?// exist then we resolve with a doc.exists set to false. If
 ...
 * @internal
 */function sf(e,t){return function(e,t){let r=new T;return e.asyncQueue.enqueueAndForget(async()=>nK(await ii(e).then(e=>e.syncEngine),t,r)),r.promise}(iI(e),t)}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
