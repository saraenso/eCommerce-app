!function(){function e(e,t,n,r){Object.defineProperty(e,t,{get:n,set:r,enumerable:!0,configurable:!0})}var t="undefined"!=typeof globalThis?globalThis:"undefined"!=typeof self?self:"undefined"!=typeof window?window:"undefined"!=typeof global?global:{},n={},r={},i=t.parcelRequire716c;null==i&&((i=function(e){if(e in n)return n[e].exports;if(e in r){var t=r[e];delete r[e];var i={id:e,exports:{}};return n[e]=i,t.call(i.exports,i,i.exports),i.exports}var s=Error("Cannot find module '"+e+"'");throw s.code="MODULE_NOT_FOUND",s}).register=function(e,t){r[e]=t},t.parcelRequire716c=i),i.register("hzcNp",function(t,n){e(t.exports,"default",function(){return l}),i("1Nsm9");var r=i("dZnwr");i("lmqRc");var s=i("a7hlc"),a=i("72yzF");let o={apiKey:"AIzaSyBF4A_qZPX5HB-mv8rRXt0DTdCqLGT68ac",authDomain:"ecommerce-app-feb0d.firebaseapp.com",projectId:"ecommerce-app-feb0d",storageBucket:"ecommerce-app-feb0d.appspot.com",messagingSenderId:"803168511954",appId:"1:803168511954:web:714cb8e9e339617c53ca0b"};var l=function(){let e=(0,r.initializeApp)(o),t=(0,s.getFirestore)(e);return{getData:async function(){let e=(0,s.collection)(t,a.ITEMS_STORAGE_KEY),n=(0,s.query)(e,(0,s.orderBy)("createdAt")),r=await (0,s.getDocs)(n),i=[];return r.forEach(e=>{i.push({id:e.id,model:e.data().model,quantity:e.data().quantity,series:e.data().series,cost:e.data().price.cost,currency:e.data().price.currency,description:{shortDescription:e.data().description.shortDescription,longDescription:e.data().description.longDescription,miniDescription:e.data().description.miniDescription},rating:e.data().rating,imageURL:e.data().imageURL,createdAt:e.data().createdAt})}),i},addToOrders:async function(e){try{let n=(0,s.collection)(t,a.ORDERS_STORAGE_KEY),r=(0,s.query)(n,(0,s.where)("id","==",e.id)),i=await (0,s.getDocs)(r);if(console.log("Success add to orders"),i.empty){let t=(0,s.doc)(n,e.id);await (0,s.setDoc)(t,{id:e.id,quantity:1,model:e.model,series:e.series,cost:e.cost,currency:e.currency,description:{shortDescription:e.description.shortDescription,longDescription:e.description.longDescription,miniDescription:e.description.miniDescription},rating:e.rating,imageURL:e.imageURL,createdAt:(0,s.serverTimestamp)()})}else{let e=i.docs[0],n=e.data().quantity+1;await (0,s.updateDoc)((0,s.doc)(t,a.ORDERS_STORAGE_KEY,e.id),{quantity:n})}}catch(e){console.error("Error adding/updating order:",e)}},getOrders:async function(){let e=(0,s.collection)(t,a.ORDERS_STORAGE_KEY),n=(0,s.query)(e,(0,s.orderBy)("createdAt")),r=await (0,s.getDocs)(n),i=[];return r.forEach(e=>{i.push({id:e.id,model:e.data().model,quantity:e.data().quantity,series:e.data().series,cost:e.data().cost,currency:e.data().currency,description:{shortDescription:e.data().description.shortDescription,longDescription:e.data().description.longDescription,miniDescription:e.data().description.miniDescription},rating:e.data().rating,imageURL:e.data().imageURL,createdAt:e.data().createdAt})}),console.log("Orders from Firestore:",i),i},clearOrders:async function(e){try{let n=(0,s.writeBatch)(t);e.forEach(e=>{let r=(0,s.doc)(t,a.ORDERS_STORAGE_KEY,e.id);n.delete(r)}),await n.commit(),console.log("Successfully cleared orders.")}catch(e){console.error("Error clearing orders:",e)}},updateOrderQuantity:async function(e,n){try{let r=(0,s.collection)(t,a.ORDERS_STORAGE_KEY),i=(0,s.query)(r,(0,s.where)("id","==",e)),o=await (0,s.getDocs)(i);if(o.empty)console.log(`Item with ID ${e} not found in orders.`);else{let r=(0,s.doc)(t,a.ORDERS_STORAGE_KEY,e),i=o.docs[0].data();"increase"===n?(await (0,s.updateDoc)(r,{quantity:i.quantity+1}),console.log(`Increased quantity of item with ID ${e} by 1.`)):"decrease"===n&&i.quantity>1?(await (0,s.updateDoc)(r,{quantity:i.quantity-1}),console.log(`Decreased quantity of item with ID ${e} by 1.`)):console.log(`Can't decrease the quantity of item with ID ${e} below 1.`)}}catch(e){console.error("Error updating order quantity:",e)}},getItemById:async function(e){let n=(0,s.doc)(t,a.ITEMS_STORAGE_KEY,e),r=await (0,s.getDoc)(n);if(!r.exists())return null;{let e=r.data();return{id:r.id,model:e.model,quantity:e.quantity,series:e.series,cost:e.price.cost,currency:e.price.currency,description:{shortDescription:e.description.shortDescription,longDescription:e.description.longDescription,miniDescription:e.description.miniDescription},rating:e.rating,imageURL:e.imageURL,createdAt:e.createdAt}}},addCompletedOrder:async function(e){try{let n=(0,s.collection)(t,a.COMPLETEDORDERS_STORAGE_KEY);await (0,s.setDoc)((0,s.doc)(n),{customerName:e.customerName,customerAddress:e.customerAddress,customerCity:e.customerCity,customerTelephone:e.customerTelephone,items:e.items,totalGoodsSum:e.totalGoodsSum,totalAmount:e.totalAmount,payMethod:e.payMethod,deliveryCost:6.99,currency:e.items[0].currency,createdAt:(0,s.serverTimestamp)()}),console.log("Successfully added completed order to Firestore.")}catch(e){console.error("Error adding completed order:",e)}},getCompletedOrders:async function(){try{let e=(0,s.collection)(t,a.COMPLETEDORDERS_STORAGE_KEY),n=(0,s.query)(e,(0,s.orderBy)("createdAt")),r=await (0,s.getDocs)(n),i=[];return r.forEach(e=>{i.push({id:e.id,customerName:e.data().customerName,customerAddress:e.data().customerAddress,customerCity:e.data().customerCity,customerTelephone:e.data().customerTelephone,items:e.data().items,totalGoodsSum:e.data().totalGoodsSum,totalAmount:e.data().totalAmount,payMethod:e.data().payMethod,deliveryCost:e.data().deliveryCost,currency:e.data().currency,createdAt:e.data().createdAt})}),console.log("Completed orders from Firestore:",i),i;// Возвращаем массив с завершенными заказами
}catch(e){console.error("Error fetching completed orders:",e)}},db:t}}}),i.register("1Nsm9",function(t,n){e(t.exports,"initializeApp",function(){return i("dZnwr").initializeApp}),e(t.exports,"registerVersion",function(){return i("dZnwr").registerVersion}),/**
 * @license
...
return(0,a.base64urlEncodeWithoutPadding)(JSON.stringify({version:2,heartbeats:e})).length}m(new r.Component("platform-logger",e=>new l(e),"PRIVATE"/* ComponentType.PRIVATE */)),m(new r.Component("heartbeat",e=>new R(e),"PRIVATE"/* ComponentType.PRIVATE */)),// Register `app` package.
...
let t=new o(e,this);return this.providers.set(e,t),t}getProviders(){return Array.from(this.providers.values())}}}),i.register("6zkFe",function(n,r){e(n.exports,"base64urlEncodeWithoutPadding",function(){return c}),e(n.exports,"getDefaultEmulatorHostnameAndPort",function(){return v}),e(n.exports,"getDefaultAppConfig",function(){return w}),e(n.exports,"Deferred",function(){return E}),e(n.exports,"createMockUserToken",function(){return _}),e(n.exports,"getUA",function(){return b}),e(n.exports,"isSafari",function(){return T}),e(n.exports,"isIndexedDBAvailable",function(){return I}),e(n.exports,"validateIndexedDBOpenable",function(){return S}),e(n.exports,"FirebaseError",function(){return A}),e(n.exports,"ErrorFactory",function(){return C}),e(n.exports,"deepEqual",function(){return(/**
...
o.set(e,t)}(t),s(t,r||(r=[IDBDatabase,IDBObjectStore,IDBIndex,IDBCursor,IDBTransaction])))?new Proxy(t,c):t;return n!==e&&(u.set(e,n),h.set(n,e)),n}let p=e=>h.get(e)}),i.register("lmqRc",function(t,n){e(t.exports,"collection",function(){return i("a7hlc").collection}),e(t.exports,"doc",function(){return i("a7hlc").doc}),e(t.exports,"getDoc",function(){return i("a7hlc").getDoc}),e(t.exports,"getDocs",function(){return i("a7hlc").getDocs}),e(t.exports,"getFirestore",function(){return i("a7hlc").getFirestore}),e(t.exports,"orderBy",function(){return i("a7hlc").orderBy}),e(t.exports,"query",function(){return i("a7hlc").query}),e(t.exports,"serverTimestamp",function(){return i("a7hlc").serverTimestamp}),e(t.exports,"setDoc",function(){return i("a7hlc").setDoc}),e(t.exports,"updateDoc",function(){return i("a7hlc").updateDoc}),e(t.exports,"where",function(){return i("a7hlc").where}),e(t.exports,"writeBatch",function(){return i("a7hlc").writeBatch}),i("a7hlc")}),i.register("a7hlc",function(t,n){e(t.exports,"collection",function(){return iw}),e(t.exports,"doc",function(){return iE}),e(t.exports,"getFirestore",function(){return iT}),e(t.exports,"query",function(){return i2}),e(t.exports,"where",function(){return i4}),e(t.exports,"orderBy",function(){return i3}),e(t.exports,"getDoc",function(){return sl}),e(t.exports,"getDocs",function(){return sh}),e(t.exports,"setDoc",function(){return sc}),e(t.exports,"updateDoc",function(){return sd}),e(t.exports,"serverTimestamp",function(){return sm}),e(t.exports,"writeBatch",function(){return sy});var r,s,a=i("dZnwr"),o=i("lrvMc"),l=i("4Qo5T"),u=i("6zkFe"),h=i("fcjPQ");i("fW3Z9");let c="@firebase/firestore";/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 */class j{constructor(/**
     ...
     */n){this.readTime=e,this.documentKey=t,this.largestBatchId=n}/** Returns an offset that sorts before all regular offsets. */static min(){return new j(P.min(),q.empty(),-1)}/** Returns an offset that sorts after all regular offsets. */static max(){return new j(P.max(),q.empty(),-1)}}/**
 ...
 */class ek{constructor(e){this.value=e}static empty(){return new ek({mapValue:{}})}/**
     ...
     */field(e){if(e.isEmpty())return this.value;{let t=this.value;for(let n=0;n<e.length-1;++n)if(!eC(t=(t.mapValue.fields||{})[e.get(n)]))return null;return(t=(t.mapValue.fields||{})[e.lastSegment()])||null}}/**
...
let e=this.getFieldsMap(t);this.applyChanges(e,n,r),n={},r=[],t=i.popLast()}e?n[i.lastSegment()]=eD(e):r.push(i.lastSegment())});let i=this.getFieldsMap(t);this.applyChanges(i,n,r)}/**
     ...
     */getFieldsMap(e){let t=this.value;t.mapValue.fields||(t.mapValue={fields:{}});for(let n=0;n<e.length;++n){let r=t.mapValue.fields[e.get(n)];eC(r)&&r.mapValue.fields||(r={mapValue:{fields:{}}},t.mapValue.fields[e.get(n)]=r),t=r}return t.mapValue.fields}/**
 ...
 * from all views.
 */class eR{constructor(e,t,n,r,i,s,a){this.key=e,this.documentType=t,this.version=n,this.readTime=r,this.createTime=i,this.data=s,this.documentState=a}/**
     ...
     * given version.
     */static newFoundDocument(e,t,n,r){return new eR(e,1/* DocumentType.FOUND_DOCUMENT */,/* version */t,/* readTime */P.min(),/* createTime */n,r,0/* DocumentState.SYNCED */)}/** Creates a new document that is known to not exist at the given version. */static newNoDocument(e,t){return new eR(e,2/* DocumentType.NO_DOCUMENT */,/* version */t,/* readTime */P.min(),/* createTime */P.min(),ek.empty(),0/* DocumentState.SYNCED */)}/**
 ...
 */class ex{constructor(e,t){this.position=e,this.inclusive=t}}function eL(e,t,n){let r=0;for(let i=0;i<e.position.length;i++){let s=t[i],a=e.position[i];if(r=s.field.isKeyField()?q.comparator(q.fromName(a.referenceValue),n.key):ew(a,n.data.field(s.field)),"desc"/* Direction.DESCENDING */===s.dir&&(r*=-1),0!==r)break}return r}/**
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */let ts=new J(q.comparator),ta=new J(q.comparator);function to(...e){let t=ta;for(let n of e)t=t.insert(n.key,n);return t}function tl(e){let t=ta;return e.forEach((e,n)=>t=t.insert(e,n.overlayedDocument)),t}function tu(){return new ti(e=>e.toString(),(e,t)=>e.isEqual(t))}let th=new J(q.comparator),tc=new et(q.comparator);function td(...e){let t=tc;for(let n of e)t=t.add(n);return t}let tf=new et(L);/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 */function tx(e,t,n,r){return e instanceof tO?function(e,t,n,r){if(!tN(e.precondition,t))// caused a name collision).
...
a=t.has(r.key)?null:a;let o=tR(s,a);null!==o&&n.set(r.key,o),s.isValidDocument()||s.convertToNoDocument(P.min())}),n}keys(){return this.mutations.reduce((e,t)=>e.add(t.key),td())}isEqual(e){return this.batchId===e.batchId&&O(this.mutations,e.mutations,(e,t)=>tL(e,t))&&O(this.baseMutations,e.baseMutations,(e,t)=>tL(e,t))}}/** The result of applying a mutation batch to the backend. */class tj{constructor(e,t,n,/**
     ...
     */static from(e,t,n){e.mutations.length===n.length||E();let r=th,i=e.mutations;for(let e=0;e<i.length;e++)r=r.insert(i[e].key,n[e].version);return new tj(e,t,n,r)}}/**
 * @license
 * Copyright 2022 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
...
// queries.
let e=new q(i.path);this.je(t,e,eR.newNoDocument(e,P.min()))}else 1===n||E()}else{let r=this.tt(t);// Existence filter mismatch. Mark the documents as being in limbo, and
...
let t=new q(i.target.path);null!==this.$e.get(t)||this.ut(r,t)||this.je(r,t,eR.newNoDocument(t,e))}n.Fe&&(t.set(r,n.xe()),n.Oe())}});let n=td();// We extract the set of limbo-only document updates as the GC logic
 ...
 */class nv{constructor(){this._n=new nw}addToCollectionParentIndex(e,t){return this._n.add(t),K.resolve()}getCollectionParents(e,t){return K.resolve(this._n.getEntries(t))}addFieldIndex(e,t){// Field indices are not supported with memory persistence.
...
return K.resolve(null)}getMinOffset(e,t){return K.resolve(j.min())}getMinOffsetFromCollectionGroup(e,t){return K.resolve(j.min())}updateCollectionGroup(e,t,n){// Field indices are not supported with memory persistence.
 ...
 * restart.
 */class n_{constructor(e){this.On=e}next(){return this.On+=2,this.On}static Nn(){// The target cache generator must return '2' in its first call to `next()`
// as there is no differentiation in the protocol layer between an unset
// number and the number '0'. If we were to sent a target with target ID
// '0', the backend would consider it unset and replace it with its own ID.
return new n_(0)}static Bn(){// Sync engine assigns target IDs for limbo document detection.
return new n_(-1)}}/**
 * @license
 * Copyright 2017 Google LLC
 *
...
r.has(t.key)&&(void 0===a||a.mutation instanceof tM)?i=i.insert(t.key,t):void 0!==a?(s.set(t.key,a.mutation.getFieldMask()),tx(a.mutation,t,a.mutation.getFieldMask(),M.now())):// Using EMPTY to indicate there is no overlay for the document.
...
// already saved.
for(;a.hasNext();){let r=a.getNext(),o=r.key,l=r.value,u=tu();l.forEach(e=>{if(!i.has(e)){let r=tR(t.get(e),n.get(e));null!==r&&u.set(e,r),i=i.add(e)}}),s.push(this.documentOverlayCache.saveOverlays(e,o,u))}return K.waitFor(s)}).next(()=>n)}/**
 ...
 * collection).
 */return q.isDocumentKey(t.path)&&null===t.collectionGroup&&0===t.filters.length?this.getDocumentsMatchingDocumentQuery(e,t.path):e4(t)?this.getDocumentsMatchingCollectionGroupQuery(e,t,n):this.getDocumentsMatchingCollectionQuery(e,t,n)}/**
...
r.forEach((t,n)=>{let r=n.getKey();null===e.get(r)&&(e=e.insert(r,eR.newInvalidDocument(r)))});// Apply the overlays and match against the query.
let n=to();return e.forEach((e,i)=>{let s=r.get(e);void 0!==s&&tx(s.mutation,i,er.empty(),M.now()),tn(t,i)&&(n=n.insert(e,i))}),n})}}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 */class nA{constructor(){// A map sorted by DocumentKey, whose value is a pair of the largest batch id
// for the overlay and the overlay itself.
this.overlays=new J(q.comparator),this.hr=new Map}getOverlay(e,t){return K.resolve(this.overlays.get(t))}getOverlays(e,t){let n=tu();return K.forEach(t,t=>this.getOverlay(e,t).next(e=>{null!==e&&n.set(t,e)})).next(()=>n)}saveOverlays(e,t,n){return n.forEach((n,r)=>{this.It(e,t,r)}),K.resolve()}removeOverlaysForBatchId(e,t,n){let r=this.hr.get(n);return void 0!==r&&(r.forEach(e=>this.overlays=this.overlays.remove(e)),this.hr.delete(n)),K.resolve()}getOverlaysForCollection(e,t,n){let r=tu(),i=t.length+1,s=new q(t.child("")),a=this.overlays.getIteratorFrom(s);for(;a.hasNext();){let e=a.getNext().value,s=e.getKey();if(!t.isPrefixOf(s.path))break;// Documents from sub-collections
...
let r=this.overlays.get(n.key);if(null!==r){let e=this.hr.get(r.largestBatchId).delete(n.key);this.hr.set(r.largestBatchId,e)}this.overlays=this.overlays.insert(n.key,new t$(t,n));// Create the association of this overlay to the given largestBatchId.
let i=this.hr.get(t);void 0===i&&(i=td(),this.hr.set(t,i)),this.hr.set(t,i.add(n.key))}}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
...
this.Pr=new et(nD.Ir),this.Tr=new et(nD.Er)}/** Returns true if the reference set contains no references. */isEmpty(){return this.Pr.isEmpty()}/** Adds a reference to the given document key for the given ID. */addReference(e,t){let n=new nD(e,t);this.Pr=this.Pr.add(n),this.Tr=this.Tr.add(n)}/** Add references to the given document keys for the given ID. */dr(e,t){e.forEach(e=>this.addReference(e,t))}/**
     * Removes a reference to the given document key for the given
     * ID.
     */removeReference(e,t){this.Ar(new nD(e,t))}Rr(e,t){e.forEach(e=>this.removeReference(e,t))}/**
     * Clears all references with a given ID. Calls removeRef() for each key
     * removed.
     */Vr(e){let t=new q(new V([])),n=new nD(t,e),r=new nD(t,e+1),i=[];return this.Tr.forEachInRange([n,r],e=>{this.Ar(e),i.push(e.key)}),i}mr(){this.Pr.forEach(e=>this.Ar(e))}Ar(e){this.Pr=this.Pr.delete(e),this.Tr=this.Tr.delete(e)}gr(e){let t=new q(new V([])),n=new nD(t,e),r=new nD(t,e+1),i=td();return this.Tr.forEachInRange([n,r],e=>{i=i.add(e.key)}),i}containsKey(e){let t=new nD(e,0),n=this.Pr.firstAfterOrEqual(t);return null!==n&&e.isEqual(n.key)}}class nD{constructor(e,t){this.key=e,this.pr=t}/** Compare by key then by ID */static Ir(e,t){return q.comparator(e.key,t.key)||L(e.pr,t.pr)}/** Compare by ID then by key */static Er(e,t){return L(e.pr,t.pr)||q.comparator(e.key,t.key)}}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 */class nN{constructor(e,t){this.indexManager=e,this.referenceDelegate=t,/**
         ...
         * the backend.
         */this.mutationQueue=[],/** Next value to use when assigning sequential IDs to each mutation batch. */this.yr=1,/** An ordered mapping between documents and the mutations batch IDs. */this.wr=new et(nD.Ir)}checkEmpty(e){return K.resolve(0===this.mutationQueue.length)}addMutationBatch(e,t,n,r){let i=this.yr;this.yr++,this.mutationQueue.length>0&&this.mutationQueue[this.mutationQueue.length-1];let s=new tq(i,t,n,r);// Track references by document key and index collection parents.
for(let t of(this.mutationQueue.push(s),r))this.wr=this.wr.add(new nD(t.key,i)),this.indexManager.addToCollectionParentIndex(e,t.key.path.popLast());return K.resolve(s)}lookupMutationBatch(e,t){return K.resolve(this.Sr(t))}getNextMutationBatchAfterBatchId(e,t){let n=this.br(t+1),r=n<0?0:n;// The requested batchId may still be out of range so normalize it to the
// start of the queue.
return K.resolve(this.mutationQueue.length>r?this.mutationQueue[r]:null)}getHighestUnacknowledgedBatchId(){return K.resolve(0===this.mutationQueue.length?-1:this.yr-1)}getAllMutationBatches(e){return K.resolve(this.mutationQueue.slice())}getAllMutationBatchesAffectingDocumentKey(e,t){let n=new nD(t,0),r=new nD(t,Number.POSITIVE_INFINITY),i=[];return this.wr.forEachInRange([n,r],e=>{let t=this.Sr(e.pr);i.push(t)}),K.resolve(i)}getAllMutationBatchesAffectingDocumentKeys(e,t){let n=new et(L);return t.forEach(e=>{let t=new nD(e,0),r=new nD(e,Number.POSITIVE_INFINITY);this.wr.forEachInRange([t,r],e=>{n=n.add(e.pr)})}),K.resolve(this.Dr(n))}getAllMutationBatchesAffectingQuery(e,t){// Use the query path as a prefix for testing if a document matches the
// query.
let n=t.path,r=n.length+1,i=n;q.isDocumentKey(i)||(i=i.child(""));let s=new nD(new q(i),0),a=new et(L);return this.wr.forEachWhile(e=>{let t=e.key.path;return!!n.isPrefixOf(t)&&// Rows with document keys more than one segment longer than the query
// path can't be matches. For example, a query on 'rooms' can't match
// the document /rooms/abc/messages/xyx.
// TODO(mcg): we'll need a different scanner when we implement
// ancestor queries.
(t.length===r&&(a=a.add(e.pr)),!0)},s),K.resolve(this.Dr(a))}Dr(e){// Construct an array of matching batches, sorted by batchID to ensure that
// multiple mutations affecting the same document key are applied in order.
let t=[];return e.forEach(e=>{let n=this.Sr(e);null!==n&&t.push(n)}),t}removeMutationBatch(e,t){0===this.vr(t.batchId,"removed")||E(),this.mutationQueue.shift();let n=this.wr;return K.forEach(t.mutations,r=>{let i=new nD(r.key,t.batchId);return n=n.delete(i),this.referenceDelegate.markPotentiallyOrphaned(e,r.key)}).next(()=>{this.wr=n})}Mn(e){// No-op since the memory mutation queue does not maintain a separate cache.
}containsKey(e,t){let n=new nD(t,0),r=this.wr.firstAfterOrEqual(n);return K.resolve(t.isEqual(r&&r.key))}performConsistencyCheck(e){return this.mutationQueue.length,K.resolve()}/**
...
return new nR(this)}getSize(e){return K.resolve(this.size)}}/**
 ...
 */class nR extends nb{constructor(e){super(),this.ar=e}applyChanges(e){let t=[];return this.changes.forEach((n,r)=>{r.isValidDocument()?t.push(this.ar.addEntry(e,r)):this.ar.removeEntry(n)}),K.waitFor(t)}getFromCache(e,t){return this.ar.getEntry(e,t)}getAllFromCache(e,t){return this.ar.getEntries(e,t)}}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 */class nL{/**
     ...
     */constructor(e,t){this.Lr={},this.overlays={},this.kr=new H(0),this.qr=!1,this.qr=!0,this.referenceDelegate=e(this),this.Qr=new nx(this),this.indexManager=new nv,this.remoteDocumentCache=new nk(e=>this.referenceDelegate.Kr(e)),this.serializer=new nm(t),this.$r=new nS(this.serializer)}start(){return Promise.resolve()}shutdown(){// No durable state to ensure is closed on shutdown.
...
return this.indexManager}getDocumentOverlayCache(e){let t=this.overlays[e.toKey()];return t||(t=new nA,this.overlays[e.toKey()]=t),t}getMutationQueue(e,t){let n=this.Lr[e.toKey()];return n||(n=new nN(t,this.referenceDelegate),this.Lr[e.toKey()]=n),n}getTargetCache(){return this.Qr}getRemoteDocumentCache(){return this.remoteDocumentCache}getBundleCache(){return this.$r}runTransaction(e,t,n){m("MemoryPersistence","Starting transaction:",e);let r=new nO(this.kr.next());return this.referenceDelegate.Ur(),n(r).next(e=>this.referenceDelegate.Wr(r).next(()=>e)).toPromise().then(e=>(r.raiseOnCommittedEvent(),e))}Gr(e,t){return K.or(Object.values(this.Lr).map(n=>()=>n.containsKey(e,t)))}}/**
 * Memory persistence is not actually transactional, but future implementations
 * may have transaction-scoped state.
 */class nO extends ${constructor(e){super(),this.currentSequenceNumber=e}}class nM{constructor(e){this.persistence=e,/** Tracks all documents that are active in Query views. */this.zr=new nC,/** The list of documents that are potentially GCed after each transaction. */this.jr=null}static Hr(e){return new nM(e)}get Jr(){if(this.jr)return this.jr;throw E()}addReference(e,t,n){return this.zr.addReference(n,t),this.Jr.delete(n.toString()),K.resolve()}removeReference(e,t,n){return this.zr.removeReference(n,t),this.Jr.add(n.toString()),K.resolve()}markPotentiallyOrphaned(e,t){return this.Jr.add(t.toString()),K.resolve()}removeTarget(e,t){this.zr.Vr(t.targetId).forEach(e=>this.Jr.add(e.toString()));let n=this.persistence.getTargetCache();return n.getMatchingKeysForTargetId(e,t.targetId).next(e=>{e.forEach(e=>this.Jr.add(e.toString()))}).next(()=>n.removeTargetData(e,t))}Ur(){this.jr=new Set}Wr(e){// Remove newly orphaned documents.
let t=this.persistence.getRemoteDocumentCache().newChangeBuffer();return K.forEach(this.Jr,n=>{let r=q.fromPath(n);return this.Yr(e,r).next(e=>{e||t.removeEntry(r,P.min())})}).next(()=>(this.jr=null,t.apply(e)))}updateLimboDocument(e,t){return this.Yr(e,t).next(e=>{e?this.Jr.delete(t.toString()):this.Jr.add(t.toString())})}Kr(e){// For eager GC, we don't care about the document size, there are no size thresholds.
 ...
 */class nP{constructor(e,t,n,r){this.targetId=e,this.fromCache=t,this.qi=n,this.Qi=r}static Ki(e,t){let n=td(),r=td();for(let e of t.docChanges)switch(e.type){case 0/* ChangeType.Added */:n=n.add(e.doc.key);break;case 1/* ChangeType.Removed */:r=r.add(e.doc.key)}return new nP(e,t.fromCache,n,r)}}/**
 * @license
 * Copyright 2019 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 */class nF{constructor(){this.$i=!1}/** Sets the document view to query against. */initialize(e,t){this.Ui=e,this.indexManager=t,this.$i=!0}/** Returns all local documents matching the specified query. */getDocumentsMatchingQuery(e,t,n,r){return this.Wi(e,t).next(i=>i||this.Gi(e,t,r,n)).next(n=>n||this.zi(e,t))}/**
...
return K.resolve(null);let n=e5(t);return this.indexManager.getIndexType(e,n).next(r=>0/* IndexType.NONE */===r?null:(null!==t.limit&&1/* IndexType.PARTIAL */===r&&(n=e5(// We cannot apply a limit for targets that are served using a partial
    ...
    t=e7(t,null,"F"/* LimitType.First */))),this.indexManager.getDocumentsMatchingTarget(e,n).next(r=>{let i=td(...r);return this.Ui.getDocuments(e,i).next(r=>this.indexManager.getMinOffset(e,n).next(n=>{let s=this.ji(t,r);return this.Hi(t,s,i,n.readTime)?this.Wi(e,e7(t,null,"F"/* LimitType.First */)):this.Ji(e,s,t,n)}))})))}/**
     * Performs a query based on the target's persisted query mapping. Returns
     * `null` if the mapping is not available or cannot be used.
     */Gi(e,t,n,r){return e1(t)||r.isEqual(P.min())?this.zi(e,t):this.Ui.getDocuments(e,n).next(i=>{let s=this.ji(t,i);return this.Hi(t,s,n,r)?this.zi(e,t):(g()<=l.LogLevel.DEBUG&&m("QueryEngine","Re-using previous result from %s to execute query: %s",r.toString(),tt(t)),this.Ji(e,s,t,/**
...
let n=e.toTimestamp().seconds,r=e.toTimestamp().nanoseconds+1,i=P.fromTimestamp(1e9===r?new M(n+1,0):new M(n,r));return new j(i,q.empty(),-1)}(r,0)))});// Queries that have never seen a snapshot without limbo free documents
...
let i="F"/* LimitType.First */===e.limitType?t.last():t.first();return!!i&&(i.hasPendingWrites||i.version.compareTo(r)>0)}zi(e,t){return g()<=l.LogLevel.DEBUG&&m("QueryEngine","Using full collection scan to execute query:",tt(t)),this.Ui.getDocumentsMatchingQuery(e,t,j.min())}/**
 ...
 */class nV{constructor(/** Manages our in-memory or durable persistence. */e,t,n,r){this.persistence=e,this.Yi=t,this.serializer=r,/**
...
// user change
this.documentOverlayCache=this.persistence.getDocumentOverlayCache(e),this.indexManager=this.persistence.getIndexManager(e),this.mutationQueue=this.persistence.getMutationQueue(e,this.indexManager),this.localDocuments=new nI(this.ts,this.mutationQueue,this.documentOverlayCache,this.indexManager),this.ts.setIndexManager(this.indexManager),this.Yi.initialize(this.localDocuments,this.indexManager)}collectGarbage(e){return this.persistence.runTransaction("Collect garbage","readwrite-primary",t=>e.collect(t,this.Zi))}}/**
...
// before and after.
let r;return e.mutationQueue.getAllMutationBatches(n).next(i=>(r=i,e.ns(t),e.mutationQueue.getAllMutationBatches(n))).next(t=>{let i=[],s=[],a=td();for(let e of r)for(let t of(i.push(e.batchId),e.mutations))a=a.add(t.key);for(let e of t)for(let t of(s.push(e.batchId),e.mutations))a=a.add(t.key);// Return the set of all (potentially) changed documents and the list
 ...
 */function nB(e){return e.persistence.runTransaction("Get last remote snapshot version","readonly",t=>e.Qr.getLastRemoteSnapshotVersion(t))}/**
...
async function nq(e,t,n){let r=e.Zi.get(t);try{n||await e.persistence.runTransaction("Release target",n?"readwrite":"readwrite-primary",t=>e.persistence.referenceDelegate.removeTarget(t,r))}catch(e){if(!G(e))throw e;// All `releaseTarget` does is record the final metadata state for the
// target, but we've been recording this periodically during target
// activity. If we lose this write this could cause a very slight
// difference in the order of target deletion during GC, but we
// don't define exact LRU semantics so this is acceptable.
m("LocalStore",`Failed to update sequence numbers for target ${t}: ${e}`)}e.Zi=e.Zi.remove(t),e.Xi.delete(r.target)}/**
 ...
 */function nj(e,t,n){let r=P.min(),i=td();return e.persistence.runTransaction("Execute query","readonly",s=>(function(e,t,n){let r=e.Xi.get(n);return void 0!==r?K.resolve(e.Zi.get(r)):e.Qr.getTargetData(t,n)})(e,s,e5(t)).next(t=>{if(t)return r=t.lastLimboFreeSnapshotVersion,e.Qr.getMatchingKeysForTargetId(s,t.targetId).next(e=>{i=e})}).next(()=>e.Yi.getDocumentsMatchingQuery(s,t,n?r:P.min(),n?i:td())).next(n=>{var r;let s;return r=t.collectionGroup||(t.path.length%2==1?t.path.lastSegment():t.path.get(t.path.length-2)),s=e.es.get(r)||P.min(),n.forEach((e,t)=>{t.readTime.compareTo(s)>0&&(s=t.readTime)}),e.es.set(r,s),{documents:n,_s:i}}))}/**
 ...
 * `toWebStorageJSON()`.
 */// Visible for testing.
class n${constructor(){this.activeTargetIds=tf}Is(e){this.activeTargetIds=this.activeTargetIds.add(e)}Ts(e){this.activeTargetIds=this.activeTargetIds.delete(e)}/**
     * Converts this entry into a JSON-encoded format we can use for WebStorage.
     * Does not encode `clientId` as it is part of the key in WebStorage.
     */Ps(){let e={activeTargetIds:this.activeTargetIds.toArray(),updateTimeMs:Date.now()};return JSON.stringify(e)}}class nz{constructor(){this.Ys=new n$,this.Zs={},this.onlineStateHandler=null,this.sequenceNumberHandler=null}addPendingMutation(e){// No op.
}updateMutationState(e,t,n){// No op.
}addLocalQueryTarget(e){return this.Ys.Is(e),this.Zs[e]||"not-current"}updateQueryState(e,t,n){this.Zs[e]=t}removeLocalQueryTarget(e){this.Ys.Ts(e)}isLocalQueryTarget(e){return this.Ys.activeTargetIds.has(e)}clearQueryState(e){delete this.Zs[e]}getAllActiveQueryTargets(){return this.Ys.activeTargetIds}isActiveQueryTarget(e){return this.Ys.activeTargetIds.has(e)}start(){return this.Ys=new n$,Promise.resolve()}handleUserChange(e,t,n){// No op.
 ...
 */class nY{constructor(e){this._o=e._o,this.ao=e.ao}uo(e){this.co=e}lo(e){this.ho=e}onMessage(e){this.Po=e}close(){this.ao()}send(e){this._o(e)}Io(){this.co()}To(e){this.ho(e)}Eo(e){this.Po(e)}}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
...
return!1}fo(e,t,n,r,i){let s=nQ(),a=this.po(e,t);m("RestConnection",`Sending RPC '${e}' ${s}:`,a,n);let o={"google-cloud-resource-prefix":this.Ro,"x-goog-request-params":this.Vo};return this.yo(o,r,i),this.wo(e,a,o,n).then(t=>(m("RestConnection",`Received RPC '${e}' ${s}: `,t),t),t=>{throw v("RestConnection",`RPC '${e}' ${s} failed with error: `,t,"url: ",a,"request:",n),t})}So(e,t,n,r,i,s){// The REST API automatically aggregates all of the streamed results, so we
...
e["Content-Type"]="text/plain",this.databaseInfo.appId&&(e["X-Firebase-GMPID"]=this.databaseInfo.appId),t&&t.headers.forEach((t,n)=>e[n]=t),n&&n.headers.forEach((t,n)=>e[n]=t)}po(e,t){let n=nW[e];return`${this.Ao}/v1/${t}:${n}`}}{constructor(e){super(e),this.forceLongPolling=e.forceLongPolling,this.autoDetectLongPolling=e.autoDetectLongPolling,this.useFetchStreams=e.useFetchStreams,this.longPollingOptions=e.longPollingOptions}wo(e,t,n,r){let i=nQ();return new Promise((s,a)=>{let o=new h.XhrIo;o.setWithCredentials(!0),o.listenOnce(h.EventType.COMPLETE,()=>{try{switch(o.getLastErrorCode()){case h.ErrorCode.NO_ERROR:let t=o.getResponseJson();m(nX,`XHR for RPC '${e}' ${i} received:`,JSON.stringify(t)),s(t);break;case h.ErrorCode.TIMEOUT:m(nX,`RPC '${e}' ${i} timed out`),a(new b(_.DEADLINE_EXCEEDED,"Request time out"));break;case h.ErrorCode.HTTP_ERROR:let n=o.getStatus();if(m(nX,`RPC '${e}' ${i} failed with status:`,n,"response text:",o.getResponseText()),n>0){let e=o.getResponseJson();Array.isArray(e)&&(e=e[0]);let t=null==e?void 0:e.error;if(t&&t.status&&t.message){let e=function(e){let t=e.toLowerCase().replace(/_/g,"-");return Object.values(_).indexOf(t)>=0?t:_.UNKNOWN}(t.status);a(new b(e,t.message))}else a(new b(_.UNKNOWN,"Server responded with status "+o.getStatus()))}else // it's most probably a connection issue
a(new b(_.UNAVAILABLE,"Connection failed."));break;default:E()}}finally{m(nX,`RPC '${e}' ${i} completed.`)}});let l=JSON.stringify(r);m(nX,`RPC '${e}' ${i} sending request:`,r),o.send(t,"POST",l,n,15)})}bo(e,t,n){let i=nQ(),s=[this.Ao,"/","google.firestore.v1.Firestore","/",e,"/channel"],a=(0,h.createWebChannelTransport)(),o=(0,h.getStatEventTarget)(),l={// Required for backend stickiness, routing behavior is based on this
// parameter.
...
l.encodeInitMessageHeaders=!0;let c=s.join("");m(nX,`Creating RPC '${e}' stream ${i}: ${c}`,l);let d=a.createWebChannel(c,l),f=!1,p=!1,g=new nY({_o:t=>{p?m(nX,`Not sending because RPC '${e}' stream ${i} is closed:`,t):(f||(m(nX,`Opening RPC '${e}' stream ${i} transport.`),d.open(),f=!0),m(nX,`RPC '${e}' stream ${i} sending:`,t),d.send(t))},ao:()=>d.close()}),y=(e,t,n)=>{// TODO(dimond): closure typing seems broken because WebChannel does
...
return y(d,h.WebChannel.EventType.OPEN,()=>{p||m(nX,`RPC '${e}' stream ${i} transport opened.`)}),y(d,h.WebChannel.EventType.CLOSE,()=>{p||(p=!0,m(nX,`RPC '${e}' stream ${i} transport closed`),g.To())}),y(d,h.WebChannel.EventType.ERROR,t=>{p||(p=!0,v(nX,`RPC '${e}' stream ${i} transport errored:`,t),g.To(new b(_.UNAVAILABLE,"The operation could not be completed")))}),y(d,h.WebChannel.EventType.MESSAGE,t=>{var n;if(!p){let s=t.data[0];s||E();// TODO(b/35143891): There is a bug in One Platform that caused errors
...
// eslint-disable-next-line @typescript-eslint/no-explicit-any
let t=r[e];if(void 0!==t)return tK(t)}(t),s=a.message;void 0===n&&(n=_.INTERNAL,s="Unknown error status: "+t+" with message "+a.message),p=!0,g.To(new b(n,s)),d.close()}else m(nX,`RPC '${e}' stream ${i} received:`,s),g.Eo(s)}}),y(o,h.Event.STAT_EVENT,t=>{t.stat===h.Stat.PROXY?m(nX,`RPC '${e}' stream ${i} detected buffering proxy`):t.stat===h.Stat.NOPROXY&&m(nX,`RPC '${e}' stream ${i} detected no buffering proxy`)}),setTimeout(()=>{// Technically we could/should wait for the WebChannel opened event,
// but because we want to send the first message with the WebChannel
// handshake we pretend the channel opened here (asynchronously), and
// then delay the actual open until the first message is sent.
g.Io()},0),g}}/** The Platform's 'document' implementation or null if not available. */function nZ(){// `document` is not always available, e.g. in ReactNative and WebWorkers.
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function n0(e){return new t8(e,/* useProto3Json= */!0)}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
...
r>0&&m("ExponentialBackoff",`Backing off for ${r} ms (base delay: ${this.Fo} ms, delay with jitter: ${t} ms, last attempt: ${n} ms ago)`),this.Mo=this.oi.enqueueAfterDelay(this.timerId,r,()=>(this.xo=Date.now(),e())),// bounds.
 ...
 */class n2{constructor(e,t,n,r,i,s,a,o){this.oi=e,this.ko=n,this.qo=r,this.connection=i,this.authCredentialsProvider=s,this.appCheckCredentialsProvider=a,this.listener=o,this.state=0/* PersistentStreamState.Initial */,/**
         * A close count that's incremented every time the stream is closed; used by
         * getCloseGuardedDispatcher() to invalidate callbacks that happen after
         * close.
         */this.Qo=0,this.Ko=null,this.$o=null,this.stream=null,this.Uo=new n1(e,t)}/**
...
n.readTime=nt(e,t.snapshotVersion.toTimestamp());let r=ne(e,t.expectedCount);null!==r&&(n.expectedCount=r)}return n}(this.serializer,e);let n=function(e,t){let n=function(e){switch(e){case"TargetPurposeListen"/* TargetPurpose.Listen */:return null;case"TargetPurposeExistenceFilterMismatch"/* TargetPurpose.ExistenceFilterMismatch */:return"existence-filter-mismatch";case"TargetPurposeExistenceFilterMismatchBloom"/* TargetPurpose.ExistenceFilterMismatchBloom */:return"existence-filter-mismatch-bloom";case"TargetPurposeLimboResolution"/* TargetPurpose.LimboResolution */:return"limbo-document";default:return E()}}(t.purpose);return null==n?null:{"goog-listen-tags":n}}(this.serializer,e);n&&(t.labels=n),this.Yo(t)}/**
     ...
     * given targetId.
     */__(e){let t={};t.database=nu(this.serializer),t.removeTarget=e,this.Yo(t)}}/**
 ...
 */class n4 extends n2{constructor(e,t,n,r,i,s){super(e,"write_stream_connection_backoff"/* TimerId.WriteStreamConnectionBackoff */,"write_stream_idle"/* TimerId.WriteStreamIdle */,"health_check_timeout"/* TimerId.HealthCheckTimeout */,t,n,r,s),this.serializer=i,this.a_=!1}/**
     * Tracks whether or not a handshake has been successfully exchanged and
     * the stream is ready to accept mutations.
     */get u_(){return this.a_}// Override of PersistentStream.start
start(){this.a_=!1,this.lastStreamToken=void 0,super.start()}e_(){this.a_&&this.c_([])}i_(e,t){return this.connection.bo("Write",e,t)}onMessage(e){var t,n;if(e.streamToken||E(),this.lastStreamToken=e.streamToken,this.a_){// A successful first write response means the stream is healthy,
// Note, that we could consider a successful handshake healthy, however,
// the write itself might be causing an error we want to back off from.
this.Uo.reset();let r=(t=e.writeResults,n=e.commitTime,t&&t.length>0?(void 0!==n||E(),t.map(e=>{let t;return(t=e.updateTime?nr(e.updateTime):nr(n)).isEqual(P.min())&&// The Firestore Emulator currently returns an update time of 0 for
// deletes of non-existing documents (rather than null). This breaks the
// test "get deleted doc while offline with source=cache" as NoDocuments
// with version 0 are filtered by IndexedDb's RemoteDocumentCache.
// TODO(#2149): Remove this when Emulator is fixed
(t=nr(n)),new tC(t,e.transformResults||[])})):[]),i=nr(e.commitTime);return this.listener.l_(i,r)}// The first response is always the handshake response
 ...
 * consumption.
 */class n6 extends class{}{constructor(e,t,n,r){super(),this.authCredentials=e,this.appCheckCredentials=t,this.connection=n,this.serializer=r,this.I_=!1}T_(){if(this.I_)throw new b(_.FAILED_PRECONDITION,"The client has already been terminated.")}/** Invokes the provided RPC with auth and AppCheck tokens. */fo(e,t,n){return this.T_(),Promise.all([this.authCredentials.getToken(),this.appCheckCredentials.getToken()]).then(([r,i])=>this.connection.fo(e,t,n,r,i)).catch(e=>{throw"FirebaseError"===e.name?(e.code===_.UNAUTHENTICATED&&(this.authCredentials.invalidateToken(),this.appCheckCredentials.invalidateToken()),e):new b(_.UNKNOWN,e.toString())})}/** Invokes the provided RPC with streamed results with auth and AppCheck tokens. */So(e,t,n,r){return this.T_(),Promise.all([this.authCredentials.getToken(),this.appCheckCredentials.getToken()]).then(([i,s])=>this.connection.So(e,t,n,i,s,r)).catch(e=>{throw"FirebaseError"===e.name?(e.code===_.UNAUTHENTICATED&&(this.authCredentials.invalidateToken(),this.appCheckCredentials.invalidateToken()),e):new b(_.UNKNOWN,e.toString())})}terminate(){this.I_=!0}}/**
...
// down our streams.
ra(this)&&(m("RemoteStore","Restarting streams for network reachability change."),await async function(e){e.S_.add(4/* OfflineCause.ConnectivityChange */),await n8(e),e.v_.set("Unknown"/* OnlineState.Unknown */),e.S_.delete(4/* OfflineCause.ConnectivityChange */),await n7(e)}(this))})}),this.v_=new n5(n,r)}}async function n7(e){if(ra(e))for(let t of e.b_)await t(/* enabled= */!0)}/**
 * Temporarily disables the network. The network can be re-enabled using
 * enableNetwork().
 */async function n8(e){for(let t of e.b_)await t(/* enabled= */!1)}/**
 * Starts new listen for the given target. Uses resume token if provided. It
 * is a no-op if the target of given `TargetData` is already being listened to.
 */function re(e,t){e.w_.has(t.targetId)||// Mark this as something the client is currently listening for.
(e.w_.set(t.targetId,t),rs(e)?ri(e):r_(e).Go()&&rn(e,t))}/**
 * Removes the listen from server. It is a no-op if the given target id is
 * not being listened to.
 */function rt(e,t){let n=r_(e);e.w_.delete(t),n.Go()&&rr(e,t),0===e.w_.size&&(n.Go()?n.Ho():ra(e)&&// Revert to OnlineState.Unknown if the watch stream is not open and we
// have no listeners, since without any listens to send we cannot
// confirm if the stream is healthy and upgrade to OnlineState.Online.
e.v_.set("Unknown"/* OnlineState.Unknown */))}/**
 * We need to increment the the expected number of pending responses we're due
 * from watch so we wait for the ack to process any messages from this target.
 */function rn(e,t){if(e.C_.Le(t.targetId),t.resumeToken.approximateByteSize()>0||t.snapshotVersion.compareTo(P.min())>0){let n=e.remoteSyncer.getRemoteKeysForTarget(t.targetId).size;t=t.withExpectedCount(n)}r_(e).o_(t)}/**
 * We need to increment the expected number of pending responses we're due
 * from watch so we wait for the removal on the server before we process any
 * messages from this target.
 */function rr(e,t){e.C_.Le(t),r_(e).__(t)}function ri(e){e.C_=new t9({getRemoteKeysForTarget:t=>e.remoteSyncer.getRemoteKeysForTarget(t),lt:t=>e.w_.get(t)||null,st:()=>e.datastore.serializer.databaseId}),r_(e).start(),e.v_.V_()}/**
 * Returns whether the watch stream should be started because it's necessary
 * and has not yet been started.
 */function rs(e){return ra(e)&&!r_(e).Wo()&&e.w_.size>0}function ra(e){return 0===e.S_.size}async function ro(e){e.w_.forEach((t,n)=>{rn(e,t)})}async function rl(e,t){e.C_=void 0,rs(e)?(e.v_.g_(t),ri(e)):// The online state is set to unknown because there is no active attempt
// at establishing a connection
e.v_.set("Unknown"/* OnlineState.Unknown */)}async function ru(e,t,n){if(e.v_.set("Online"/* OnlineState.Online */),t instanceof t1&&2/* WatchTargetChangeState.Removed */===t.state&&t.cause)// to raise events
try{await /** Handles an error on a target */async function(e,t){let n=t.cause;for(let r of t.targetIds)e.w_.has(r)&&(await e.remoteSyncer.rejectListen(r,n),e.w_.delete(r),e.C_.removeTarget(r))}(e,t)}catch(n){m("RemoteStore","Failed to remove targets %s: %s ",t.targetIds.join(","),n),await rh(e,n)}else if(t instanceof tZ?e.C_.Ge(t):t instanceof t0?e.C_.Xe(t):e.C_.He(t),!n.isEqual(P.min()))try{let t=await nB(e.localStore);n.compareTo(t)>=0&&// We have received a target change with a global snapshot if the snapshot
...
// state.
e.w_.set(t,r.withResumeToken(es.EMPTY_BYTE_STRING,r.snapshotVersion)),// deliberately don't send a resume token so that we get a full update.
rr(e,t);// Mark the target we send as being on behalf of an existence filter
// mismatch, but don't actually retain that in listenTargets. This ensures
// that we flag the first re-listen this way without impacting future
// listens of this target (that might happen e.g. on reconnect).
let i=new ng(r.target,t,n,r.sequenceNumber);rn(e,i)}),e.remoteSyncer.applyRemoteEvent(n)}(e,n)}catch(t){m("RemoteStore","Failed to raise snapshot:",t),await rh(e,t)}}/**
 ...
 * any retry attempt.
 */async function rh(e,t,n){if(!G(t))throw t;e.S_.add(1/* OfflineCause.IndexedDbFailed */),await n8(e),e.v_.set("Offline"/* OnlineState.Offline */),n||// Use a simple read operation to determine if IndexedDB recovered.
// Ideally, we would expose a health check directly on SimpleDb, but
// RemoteStore only has access to persistence through LocalStore.
(n=()=>nB(e.localStore)),e.asyncQueue.enqueueRetryable(async()=>{m("RemoteStore","Retrying IndexedDB access"),await n(),e.S_.delete(1/* OfflineCause.IndexedDbFailed */),await n7(e)})}/**
 * Executes `op`. If `op` fails, takes the network offline until `op`
 * succeeds. Returns after the first attempt.
 */function rc(e,t){return t().catch(n=>rh(e,n,t))}async function rd(e){let t=rb(e),n=e.y_.length>0?e.y_[e.y_.length-1].batchId:-1;for(;ra(e)&&e.y_.length<10;)try{let r=await /**
 ...
 */function(e,t){e.y_.push(t);let n=rb(e);n.Go()&&n.u_&&n.c_(t.mutations)}(e,r)}catch(t){await rh(e,t)}rf(e)&&rp(e)}function rf(e){return ra(e)&&!rb(e).Wo()&&e.y_.length>0}function rp(e){rb(e).start()}async function rg(e){rb(e).P_()}async function rm(e){let t=rb(e);// Send the write pipeline now that the stream is established.
for(let n of e.y_)t.c_(n.mutations)}async function ry(e,t,n){let r=e.y_.shift(),i=tj.from(r,t,n);await rc(e,()=>e.remoteSyncer.applySuccessfulWrite(i)),// slot has freed up.
await rd(e)}async function rv(e,t){// If the write stream closed after the write handshake completes, a write
// operation failed and we fail the pending operation.
t&&rb(e).u_&&// This error affects the actual write.
...
// restart.
rb(e).jo(),await rc(e,()=>e.remoteSyncer.rejectFailedWrite(n.batchId,t)),// another slot has freed up.
...
e.S_.add(3/* OfflineCause.CredentialChange */),await n8(e),n&&// Don't set the network status to Unknown if we are offline.
e.v_.set("Unknown"/* OnlineState.Unknown */),await e.remoteSyncer.handleCredentialChange(t),e.S_.delete(3/* OfflineCause.CredentialChange */),await n7(e)}/**
 * Toggles the network state when the client gains or loses its primary lease.
 */async function rE(e,t){t?(e.S_.delete(2/* OfflineCause.IsSecondary */),await n7(e)):t||(e.S_.add(2/* OfflineCause.IsSecondary */),await n8(e),e.v_.set("Unknown"/* OnlineState.Unknown */))}/**
 ...
 */function r_(e){var t,n,r;return e.F_||// Create stream (but note that it is not started yet).
(e.F_=(t=e.datastore,n=e.asyncQueue,r={uo:ro.bind(null,e),lo:rl.bind(null,e),s_:ru.bind(null,e)},t.T_(),new n9(n,t.connection,t.authCredentials,t.appCheckCredentials,t.serializer,r)),e.b_.push(async t=>{t?(e.F_.jo(),rs(e)?ri(e):e.v_.set("Unknown"/* OnlineState.Unknown */)):(await e.F_.stop(),e.C_=void 0)})),e.F_}/**
 ...
 * This is not done on Web to allow it to be tree-shaken.
 */function rb(e){var t,n,r;return e.M_||// Create stream (but note that it is not started yet).
(e.M_=(t=e.datastore,n=e.asyncQueue,r={uo:rg.bind(null,e),lo:rv.bind(null,e),h_:rm.bind(null,e),l_:ry.bind(null,e)},t.T_(),new n4(n,t.connection,t.authCredentials,t.appCheckCredentials,t.serializer,r)),e.b_.push(async t=>{t?(e.M_.jo(),await rd(e)):(await e.M_.stop(),e.y_.length>0&&(m("RemoteStore",`Stopping write stream with ${e.y_.length} pending writes`),e.y_=[]))})),e.M_}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
...
this.comparator=e?(t,n)=>e(t,n)||q.comparator(t.key,n.key):(e,t)=>q.comparator(e.key,t.key),this.keyedMap=to(),this.sortedSet=new J(this.comparator)}/**
 ...
 */class rA{constructor(){this.x_=new J(q.comparator)}track(e){let t=e.doc.key,n=this.x_.get(t);n?0/* ChangeType.Added */!==e.type&&3/* ChangeType.Metadata */===n.type?this.x_=this.x_.insert(t,e):3/* ChangeType.Metadata */===e.type&&1/* ChangeType.Removed */!==n.type?this.x_=this.x_.insert(t,{type:n.type,doc:e.doc}):2/* ChangeType.Modified */===e.type&&2/* ChangeType.Modified */===n.type?this.x_=this.x_.insert(t,{type:2/* ChangeType.Modified */,doc:e.doc}):2/* ChangeType.Modified */===e.type&&0/* ChangeType.Added */===n.type?this.x_=this.x_.insert(t,{type:0/* ChangeType.Added */,doc:e.doc}):1/* ChangeType.Removed */===e.type&&0/* ChangeType.Added */===n.type?this.x_=this.x_.remove(t):1/* ChangeType.Removed */===e.type&&2/* ChangeType.Modified */===n.type?this.x_=this.x_.insert(t,{type:1/* ChangeType.Removed */,doc:n.doc}):0/* ChangeType.Added */===e.type&&1/* ChangeType.Removed */===n.type?this.x_=this.x_.insert(t,{type:2/* ChangeType.Modified */,doc:e.doc}):// Added->Added
// Removed->Removed
// Modified->Added
// Removed->Modified
// Metadata->Added
// Removed->Metadata
E():this.x_=this.x_.insert(t,e)}O_(){let e=[];return this.x_.inorderTraversal((t,n)=>{e.push(n)}),e}}class rC{constructor(e,t,n,r,i,s,a,o,l){this.query=e,this.docs=t,this.oldDocs=n,this.docChanges=r,this.mutatedKeys=i,this.fromCache=s,this.syncStateChanged=a,this.excludesMetadataChanges=o,this.hasCachedResults=l}/** Returns a view snapshot as if all documents in the snapshot were added. */static fromInitialDocuments(e,t,n,r,i){let s=[];return t.forEach(e=>{s.push({type:0/* ChangeType.Added */,doc:e})}),new rC(e,t,rS.emptySet(t),s,n,r,/* syncStateChanged= */!0,/* excludesMetadataChanges= */!1,i)}get hasPendingWrites(){return!this.mutatedKeys.isEmpty()}isEqual(e){if(!(this.fromCache===e.fromCache&&this.hasCachedResults===e.hasCachedResults&&this.syncStateChanged===e.syncStateChanged&&this.mutatedKeys.isEqual(e.mutatedKeys)&&e8(this.query,e.query)&&this.docs.isEqual(e.docs)&&this.oldDocs.isEqual(e.oldDocs)))return!1;let t=this.docChanges,n=e.docChanges;if(t.length!==n.length)return!1;for(let e=0;e<t.length;e++)if(t[e].type!==n[e].type||!t[e].doc.isEqual(n[e].doc))return!1;return!0}}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 */class rD{constructor(){this.N_=void 0,this.listeners=[]}}class rN{constructor(){this.queries=new ti(e=>te(e),e8),this.onlineState="Unknown"/* OnlineState.Unknown */,this.B_=new Set}}async function rk(e,t){let n=t.query,r=!1,i=e.queries.get(n);if(i||(r=!0,i=new rD),r)try{i.N_=await e.onListen(n)}catch(n){let e=rI(n,`Initialization of query '${tt(t.query)}' failed`);return void t.onError(e)}e.queries.set(n,i),i.listeners.push(t),t.L_(e.onlineState),i.N_&&t.k_(i.N_)&&rO(e)}async function rR(e,t){let n=t.query,r=!1,i=e.queries.get(n);if(i){let e=i.listeners.indexOf(t);e>=0&&(i.listeners.splice(e,1),r=0===i.listeners.length)}if(r)return e.queries.delete(n),e.onUnlisten(n)}function rx(e,t){let n=!1;for(let r of t){let t=r.query,i=e.queries.get(t);if(i){for(let e of i.listeners)e.k_(r)&&(n=!0);i.N_=r}}n&&rO(e)}function rL(e,t,n){let r=e.queries.get(t);if(r)for(let e of r.listeners)e.onError(n);// Remove all listeners. NOTE: We don't need to call syncEngine.unlisten()
// after an error.
e.queries.delete(t)}// Call all global snapshot listeners that have been set.
function rO(e){e.B_.forEach(e=>{e.next()})}/**
 * QueryListener takes a series of internal view snapshots and determines
 * when to raise the event.
 *
 * It uses an Observer to dispatch events.
 */class rM{constructor(e,t,n){this.query=e,this.q_=t,/**
...
// stripped out.
}G_(e){e=rC.fromInitialDocuments(e.query,e.docs,e.mutatedKeys,e.fromCache,e.hasCachedResults),this.Q_=!0,this.q_.next(e)}}/**
 ...
 */class rV{constructor(e,/** Documents included in the remote target */t){this.query=e,this.ta=t,this.na=null,this.hasCachedResults=!1,/**
         * A flag whether the view is current with the backend. A view is considered
         * current after it has seen the current flag from the backend and did not
         * lose consistency within the watch stream (e.g. because of an existence
         * filter mismatch).
         */this.current=!1,/** Documents in the view but not in the remote target */this.ra=td(),/** Document Keys that have local changes */this.mutatedKeys=td(),this.ia=tr(e),this.sa=new rS(this.ia)}/**
     ...
     */_a(e,t){let n=t?t.aa:new rA,r=t?t.sa:this.sa,i=t?t.mutatedKeys:this.mutatedKeys,s=r,a=!1,o="F"/* LimitType.First */===this.query.limitType&&r.size===this.query.limit?r.last():null,l="L"/* LimitType.Last */===this.query.limitType&&r.size===this.query.limit?r.first():null;// Drop documents out to meet limit/limitToLast requirement.
...
this.mutatedKeys.has(h.key)&&h.hasCommittedMutations),f=!1;u&&h?u.data.isEqual(h.data)?c!==d&&(n.track({type:3/* ChangeType.Metadata */,doc:h}),f=!0):this.ua(u,h)||(n.track({type:2/* ChangeType.Modified */,doc:h}),f=!0,(o&&this.ia(h,o)>0||l&&0>this.ia(h,l))&&// This doc moved from inside the limit to outside the limit.
...
let i=e.aa.O_();i.sort((e,t)=>(function(e,t){let n=e=>{switch(e){case 0/* ChangeType.Added */:return 1;case 2/* ChangeType.Modified */:case 3/* ChangeType.Metadata */:// A metadata change is converted to a modified change at the public
    ...
    return 2;case 1/* ChangeType.Removed */:return 0;default:return E()}};return n(e)-n(t)})(e.type,t.type)||this.ia(e.doc,t.doc)),this.ca(n);let s=t?this.la():[],a=0===this.ra.size&&this.current?1/* SyncState.Synced */:0/* SyncState.Local */,o=a!==this.na;return(this.na=a,0!==i.length||o)?{snapshot:new rC(this.query,e.sa,r,i,e.mutatedKeys,0/* SyncState.Local */===a,o,/* excludesMetadataChanges= */!1,!!n&&n.resumeToken.approximateByteSize()>0),ha:s}:{ha:s}}/**
...
(this.current=!1,this.applyChanges({sa:this.sa,aa:new rA,mutatedKeys:this.mutatedKeys,Hi:!1},/* updateLimboDocuments= */!1)):{ha:[]}}/**
...
let t=[];return e.forEach(e=>{this.ra.has(e)||t.push(new rF(e))}),this.ra.forEach(n=>{e.has(n)||t.push(new rP(n))}),t}/**
...
Ia(e){this.ta=e._s,this.ra=td();let t=this._a(e.documents);return this.applyChanges(t,/*updateLimboDocuments=*/!0)}/**
     ...
     */// PORTING NOTE: Multi-tab only.
Ta(){return rC.fromInitialDocuments(this.query,this.sa,this.mutatedKeys,0/* SyncState.Local */===this.na,this.hasCachedResults)}}/**
 ...
 * This is useful to implement optional features (like bundles) in free
 * functions, such that they are tree-shakeable.
 */class rq{constructor(e,t,n,r,i,s){this.localStore=e,this.remoteStore=t,this.eventManager=n,this.sharedClientState=r,this.currentUser=i,this.maxConcurrentLimboResolutions=s,this.da={},this.Aa=new ti(e=>te(e),e8),this.Ra=new Map,/**
         ...
         */this.fa=new Map,this.ga=new nC,/** Stores user completion handlers, indexed by User and BatchId. */this.pa={},/** Stores user callbacks waiting for all pending writes to be acknowledged. */this.ya=new Map,this.wa=n_.Bn(),this.onlineState="Unknown"/* OnlineState.Unknown */,// startup. In the interim, a client should only be considered primary if
// `isPrimary` is true.
this.Sa=void 0}get isPrimaryClient(){return!0===this.Sa}}/**
 * Initiates the new listen, resolves promise when listen enqueued to the
 * server. All the subsequent view snapshots or errors are sent to the
 * subscribed handlers. Returns the initial snapshot.
 */async function rj(e,t){var n,r;let i,s;let a=(e.remoteStore.remoteSyncer.applyRemoteEvent=rG.bind(null,e),e.remoteStore.remoteSyncer.getRemoteKeysForTarget=r6.bind(null,e),e.remoteStore.remoteSyncer.rejectListen=rQ.bind(null,e),e.da.s_=rx.bind(null,e.eventManager),e.da.Da=rL.bind(null,e.eventManager),e),o=a.Aa.get(t);if(o)// already exists when EventManager calls us for the first time. This
// happens when the primary tab is already listening to this query on
// behalf of another tab and the user of the primary also starts listening
// to the query. EventManager will not have an assigned target ID in this
// case and calls `listen` to obtain this ID.
i=o.targetId,a.sharedClientState.addLocalQueryTarget(i),s=o.view.Ta();else{let e=await (n=a.localStore,r=e5(t),n.persistence.runTransaction("Allocate target","readwrite",e=>{let t;return n.Qr.getTargetData(e,r).next(i=>i?// previous targetID.
    // TODO(mcg): freshen last accessed date?
    (t=i,K.resolve(t)):n.Qr.allocateTargetId(e).next(i=>(t=new ng(r,i,"TargetPurposeListen"/* TargetPurpose.Listen */,e.currentSequenceNumber),n.Qr.addTargetData(e,t).next(()=>t))))}).then(e=>{// If Multi-Tab is enabled, the existing target data may be newer than
// the in-memory data
let t=n.Zi.get(e.targetId);return(null===t||e.snapshotVersion.compareTo(t.snapshotVersion)>0)&&(n.Zi=n.Zi.insert(e.targetId,e),n.Xi.set(r,e.targetId)),e})),o=a.sharedClientState.addLocalQueryTarget(e.targetId);i=e.targetId,s=await r$(a,t,i,"current"===o,e.resumeToken),a.isPrimaryClient&&re(a.remoteStore,e)}return s}/**
...
e.ba=(t,n,r)=>(async function(e,t,n,r){let i=t.view._a(n);i.Hi&&// The query has a limit and some docs were removed, so we need
    ...
    (i=await nj(e.localStore,t.query,/* usePreviousResults= */!1).then(({documents:e})=>t.view._a(e,i)));let s=r&&r.targetChanges.get(t.targetId),a=t.view.applyChanges(i,/* updateLimboDocuments= */e.isPrimaryClient,s);return r1(e,t.targetId,a.ha),a.snapshot})(e,t,n,r);let s=await nj(e.localStore,t,/* usePreviousResults= */!0),a=new rV(t,s._s),o=a._a(s.documents),l=tJ.createSynthesizedTargetChangeForCurrentChange(n,r&&"Offline"/* OnlineState.Offline */!==e.onlineState,i),u=a.applyChanges(o,/* updateLimboDocuments= */e.isPrimaryClient,l);r1(e,n,u.ha);let h=new rU(t,n,a);return e.Aa.set(t,h),e.Ra.has(n)?e.Ra.get(n).push(t):e.Ra.set(n,[t]),u.snapshot}/** Stops listening to the query. */async function rz(e,t){let n=e.Aa.get(t),r=e.Ra.get(n.targetId);if(r.length>1)return e.Ra.set(n.targetId,r.filter(e=>!e8(e,t))),void e.Aa.delete(t);e.isPrimaryClient?(// We need to remove the local query target first to allow us to verify
// whether any other client is still interested in this target.
e.sharedClientState.removeLocalQueryTarget(n.targetId),e.sharedClientState.isActiveQueryTarget(n.targetId)||await nq(e.localStore,n.targetId,/*keepPersistedTargetData=*/!1).then(()=>{e.sharedClientState.clearQueryState(n.targetId),rt(e.remoteStore,n.targetId),rZ(e,n.targetId)}).catch(z)):(rZ(e,n.targetId),await nq(e.localStore,n.targetId,/*keepPersistedTargetData=*/!0))}/**
...
//  to 0.
let o=ts,l=td();return e.ts.getEntries(a,s).next(e=>{(o=e).forEach((e,t)=>{t.isValidDocument()||(l=l.add(e))})}).next(()=>e.localDocuments.getOverlayedDocuments(a,o)).next(r=>{n=r;// For non-idempotent mutations (such as `FieldValue.increment()`),
 ...
 */function e(t){let n=[];return Y(t.fields,(t,r)=>{let i=new B([t]);if(eC(r)){let t=e(r.mapValue).fields;if(0===t.length)n.push(i);else // leaf nodes.
for(let e of t)n.push(i.child(e))}else // nodes.
n.push(i)}),new er(n)}(t.value.mapValue),tD.exists(!0)))}return e.mutationQueue.addMutationBatch(a,i,s,t)}).next(t=>{r=t;let i=t.applyToLocalDocumentSet(n,l);return e.documentOverlayCache.saveOverlays(a,t.batchId,i)})}).then(()=>({batchId:r.batchId,changes:tl(n)}))}(i.localStore,t);i.sharedClientState.addPendingMutation(s.batchId),r=s.batchId,(e=i.pa[i.currentUser.toKey()])||(e=new J(L)),e=e.insert(r,n),i.pa[i.currentUser.toKey()]=e,await r9(i,s.changes),await rd(i.remoteStore)}catch(t){// If we can't persist the mutation, we reject the user callback and
...
r=e.Zi;let u=[];t.targetChanges.forEach((s,a)=>{var o;let l=r.get(a);if(!l)return;// Only update the remote keys if the target is still active. This
...
// access.
(l.removeEntry(n,r.readTime),t=t.insert(n,r)):!i.isValidDocument()||r.version.compareTo(i.version)>0||0===r.version.compareTo(i.version)&&i.hasPendingWrites?(l.addEntry(r),t=t.insert(n,r)):m("LocalStore","Ignoring outdated watch update for ",n,". Current version:",i.version," Watch version:",r.version)}),{ss:t,os:o}})).next(e=>{h=e.ss,c=e.os})),!n.isEqual(P.min())){let t=e.Qr.getLastRemoteSnapshotVersion(i).next(t=>e.Qr.setTargetsMetadata(i,i.currentSequenceNumber,n));u.push(t)}return K.waitFor(u).next(()=>l.apply(i)).next(()=>e.localDocuments.getLocalViewOfDocuments(i,h,c)).next(()=>h)}).then(t=>(e.Zi=r,t))}(e.localStore,t);// Update `receivedDocument` as appropriate for any limbo targets.
...
(t.addedDocuments.size+t.modifiedDocuments.size+t.removedDocuments.size<=1||E(),t.addedDocuments.size>0?r.Ea=!0:t.modifiedDocuments.size>0?r.Ea||E():t.removedDocuments.size>0&&(r.Ea||E(),r.Ea=!1))}),await r9(e,n,t)}catch(e){await z(e)}}/**
 ...
 * if there are any.
 */function rX(e,t){(e.ya.get(t)||[]).forEach(e=>{e.resolve()}),e.ya.delete(t)}/** Reject all outstanding callbacks waiting for pending writes to complete. */function rJ(e,t,n){let r=e.pa[e.currentUser.toKey()];// NOTE: Mutations restored from persistence won't have callbacks, so it's
// okay for there to be no callback for this ID.
if(r){let i=r.get(t);i&&(n?i.reject(n):i.resolve(),r=r.remove(t)),e.pa[e.currentUser.toKey()]=r}}function rZ(e,t,n=null){for(let r of(e.sharedClientState.removeLocalQueryTarget(t),e.Ra.get(t)))e.Aa.delete(r),n&&e.da.Da(r,n);e.Ra.delete(t),e.isPrimaryClient&&e.ga.Vr(t).forEach(t=>{e.ga.containsKey(t)||// We removed the last reference for this key
r0(e,t)})}function r0(e,t){e.Va.delete(t.path.canonicalString());// It's possible that the target already got removed because the query failed. In that case,
// the key won't exist in `limboTargetsByKey`. Only do the cleanup if we still have the target.
let n=e.ma.get(t);null!==n&&(rt(e.remoteStore,n),e.ma=e.ma.remove(t),e.fa.delete(n),r2(e))}function r1(e,t,n){for(let r of n)r instanceof rP?(e.ga.addReference(r.key,t),function(e,t){let n=t.key,r=n.path.canonicalString();e.ma.get(n)||e.Va.has(r)||(m("SyncEngine","New document in limbo: "+n),e.Va.add(r),r2(e))}(e,r)):r instanceof rF?(m("SyncEngine","Document no longer in limbo: "+r.key),e.ga.removeReference(r.key,t),e.ga.containsKey(r.key)||// We removed the last reference for this key
r0(e,r.key)):E()}/**
 ...
 */function r2(e){for(;e.Va.size>0&&e.ma.size<e.maxConcurrentLimboResolutions;){var t;let n=e.Va.values().next().value;e.Va.delete(n);let r=new q(V.fromString(n)),i=e.wa.next();e.fa.set(i,new rB(r)),e.ma=e.ma.insert(r,i),re(e.remoteStore,new ng(e5((t=r.path,new e0(t))),i,"TargetPurposeLimboResolution"/* TargetPurpose.LimboResolution */,H.ae))}}async function r9(e,t,n){let r=[],i=[],s=[];e.Aa.isEmpty()||(e.Aa.forEach((a,o)=>{s.push(e.ba(o,t,n).then(t=>{// Update views if there are actual changes.
if(// secondary clients to update query state.
(t||n)&&e.isPrimaryClient&&e.sharedClientState.updateQueryState(o.targetId,(null==t?void 0:t.fromCache)?"not-current":"current"),t){r.push(t);let e=nP.Ki(o.targetId,t);i.push(e)}}))}),await Promise.all(s),e.da.s_(r),await async function(e,t){try{await e.persistence.runTransaction("notifyLocalViewChanges","readwrite",n=>K.forEach(t,t=>K.forEach(t.qi,r=>e.persistence.referenceDelegate.addReference(n,t.targetId,r)).next(()=>K.forEach(t.Qi,r=>e.persistence.referenceDelegate.removeReference(n,t.targetId,r)))))}catch(e){if(!G(e))throw e;// If `notifyLocalViewChanges` fails, we did not advance the sequence
// number for the documents that were included in this transaction.
// This might trigger them to be deleted earlier than they otherwise
// would have, but it should not invalidate the integrity of the data.
m("LocalStore","Failed to update sequence numbers: "+e)}for(let n of t){let t=n.targetId;if(!n.fromCache){let n=e.Zi.get(t),r=n.snapshotVersion,i=n.withLastLimboFreeSnapshotVersion(r);// Advance the last limbo free snapshot version
e.Zi=e.Zi.insert(t,i)}}}(e.localStore,i))}async function r4(e,t){if(!e.currentUser.isEqual(t)){m("SyncEngine","User change. New user:",t.toKey());let n=await nU(e.localStore,t);e.currentUser=t,e.ya.forEach(e=>{e.forEach(e=>{e.reject(new b(_.CANCELLED,"'waitForPendingWrites' promise is rejected due to a user change."))})}),e.ya.clear(),e.sharedClientState.handleUserChange(t,n.removedBatchIds,n.addedBatchIds),await r9(e,n.rs)}}function r6(e,t){let n=e.fa.get(t);if(n&&n.Ea)return td().add(n.key);{let n=td(),r=e.Ra.get(t);if(!r)return n;for(let t of r){let r=e.Aa.get(t);n=n.unionWith(r.view.oa)}return n}}class r5{constructor(){this.synchronizeTabs=!1}async initialize(e){this.serializer=n0(e.databaseInfo.databaseId),this.sharedClientState=this.createSharedClientState(e),this.persistence=this.createPersistence(e),await this.persistence.start(),this.localStore=this.createLocalStore(e),this.gcScheduler=this.createGarbageCollectionScheduler(e,this.localStore),this.indexBackfillerScheduler=this.createIndexBackfillerScheduler(e,this.localStore)}createGarbageCollectionScheduler(e,t){return null}createIndexBackfillerScheduler(e,t){return null}createLocalStore(e){var /** Manages our in-memory or durable persistence. */t,n,r,i;return t=this.persistence,n=new nF,r=e.initialUser,i=this.serializer,new nV(t,n,r,i)}createPersistence(e){return new nL(nM.Hr,this.serializer)}createSharedClientState(e){return new nz}async terminate(){this.gcScheduler&&this.gcScheduler.stop(),await this.sharedClientState.shutdown(),await this.persistence.shutdown()}}/**
 * Initializes and wires the components that are needed to interface with the
 * network.
 */class r3{async initialize(e,t){this.localStore||(this.localStore=e.localStore,this.sharedClientState=e.sharedClientState,this.datastore=this.createDatastore(t),this.remoteStore=this.createRemoteStore(t),this.eventManager=this.createEventManager(t),this.syncEngine=this.createSyncEngine(t,/* startAsPrimary=*/!e.synchronizeTabs),this.sharedClientState.onlineStateHandler=e=>rH(this.syncEngine,e,1/* OnlineStateSource.SharedClientState */),this.remoteStore.remoteSyncer.handleCredentialChange=r4.bind(null,this.syncEngine),await rE(this.remoteStore,this.syncEngine.isPrimaryClient))}createEventManager(e){return new rN}createDatastore(e){var t,n,r;let i=n0(e.databaseInfo.databaseId),s=(t=e.databaseInfo,new nJ(t));return n=e.authCredentials,r=e.appCheckCredentials,new n6(n,r,s,i)}createRemoteStore(e){var t,n,r,i;return t=this.localStore,n=this.datastore,r=e.asyncQueue,i=nG.v()?new nG:new nK,new n3(t,n,r,e=>rH(this.syncEngine,e,0/* OnlineStateSource.RemoteStore */),i)}createSyncEngine(e,t){return function(e,t,n,r,i,s,a){let o=new rq(e,t,n,r,i,s);return a&&(o.Sa=!0),o}(this.localStore,this.remoteStore,this.eventManager,this.sharedClientState,e.initialUser,e.maxConcurrentLimboResolutions,t)}terminate(){return async function(e){m("RemoteStore","RemoteStore shutting down."),e.S_.add(5/* OfflineCause.Shutdown */),await n8(e),e.D_.shutdown(),// triggering spurious listener events with cached data, etc.
 ...
 */class iv extends im{/** @hideconstructor */constructor(e,t,n){super(e,t,new e0(n)),this._path=n,/** The type of this Firestore reference. */this.type="collection"}/** The collection's identifier. */get id(){return this._query.path.lastSegment()}/**
     ...
     */get parent(){let e=this._path.popLast();return e.isEmpty()?null:new iy(this.firestore,/* converter= */null,new q(e))}withConverter(e){return new iv(this.firestore,e,this._path)}}function iw(e,t,...n){if(e=(0,u.getModularInstance)(e),il("collection","path",t),e instanceof ig){let r=V.fromString(t,...n);return ih(r),new iv(e,/* converter= */null,r)}{if(!(e instanceof iy||e instanceof iv))throw new b(_.INVALID_ARGUMENT,"Expected first argument to collection() to be a CollectionReference, a DocumentReference or FirebaseFirestore");let r=e._path.child(V.fromString(t,...n));return ih(r),new iv(e.firestore,/* converter= */null,r)}}function iE(e,t,...n){if(e=(0,u.getModularInstance)(e),// 'undefined' and 'null'.
1==arguments.length&&(t=x.V()),il("doc","path",t),e instanceof ig){let r=V.fromString(t,...n);return iu(r),new iy(e,/* converter= */null,new q(r))}{if(!(e instanceof iy||e instanceof iv))throw new b(_.INVALID_ARGUMENT,"Expected first argument to collection() to be a CollectionReference, a DocumentReference or FirebaseFirestore");let r=e._path.child(V.fromString(t,...n));return iu(r),new iy(e.firestore,e instanceof iv?e.converter:null,new q(r))}}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
...
this.Za=!1,this.Xa=!1,this.eu=[],this.Uo=new n1(this,"async_queue_retry"/* TimerId.AsyncQueueRetry */),// operations. Meant to speed up recovery when we regain file system access
// after page comes into foreground.
this.tu=()=>{let e=nZ();e&&m("AsyncQueue","Visibility state changed to "+e.visibilityState),this.Uo.Lo()};let e=nZ();e&&"function"==typeof e.addEventListener&&e.addEventListener("visibilitychange",this.tu)}get isShuttingDown(){return this.Ha}/**
     * Adds a new operation to the queue without waiting for it to complete (i.e.
     * we ignore the Promise result).
     */enqueueAndForget(e){// eslint-disable-next-line @typescript-eslint/no-floating-promises
this.enqueue(e)}enqueueAndForgetEvenWhileRestricted(e){this.nu(),this.ru(e)}enterRestrictedMode(e){if(!this.Ha){this.Ha=!0,this.Xa=e||!1;let t=nZ();t&&"function"==typeof t.removeEventListener&&t.removeEventListener("visibilitychange",this.tu)}}enqueue(e){if(this.nu(),this.Ha)return new Promise(()=>{});// Create a deferred Promise that we can return to the callee. This
...
this.Uo.No(()=>this.iu())}}ru(e){let t=this.za.then(()=>(this.Za=!0,e().catch(e=>{let t;this.Ya=e,this.Za=!1;let n=(t=e.message||"",e.stack&&(t=e.stack.includes(e.message)?e.stack:e.message+"\n"+e.stack),t);// Re-throw the error so that this.tail becomes a rejected Promise and
    ...
    throw y("INTERNAL UNHANDLED ERROR: ",n),e}).then(e=>(this.Za=!1,e))));return this.za=t,t}enqueueAfterDelay(e,t,n){this.nu(),this.eu.indexOf(e)>-1&&(t=0);let r=rT.createAndSchedule(this,e,t,n,e=>this.su(e));return this.Ja.push(r),r}nu(){this.Ya&&E()}verifyOperationInProgress(){}/**
...
iS(this),this._firestoreClient.terminate()}}function iT(e,t){let n="object"==typeof e?e:(0,a.getApp)(),r=(0,a._getProvider)(n,"firestore").getImmediate({identifier:"string"==typeof e?e:t||"(default)"});if(!r._initialized){let e=(0,u.getDefaultEmulatorHostnameAndPort)("firestore");e&&/**
...
t=(0,u.createMockUserToken)(r.mockUserToken,null===(i=e._app)||void 0===i?void 0:i.options.projectId);let s=r.mockUserToken.sub||r.mockUserToken.user_id;if(!s)throw new b(_.INVALID_ARGUMENT,"mockUserToken must contain 'sub' or 'user_id' field!");n=new d(s)}e._authCredentials=new A(new I(t,n))}}(r,...e)}return r}/**
 * @internal
 ...
 * classes.
 */class iM{constructor(e,t,n){this.databaseId=e,this.ignoreUndefinedProperties=t,this.serializer=n||n0(e)}/** Creates a new top-level parse context. */mu(e,t,n,r=!1){return new iO({lu:e,methodName:t,Vu:n,path:B.emptyPath(),Iu:!1,Ru:r},this.databaseId,this.serializer,this.ignoreUndefinedProperties)}}function iP(e){let t=e._freezeSettings(),n=n0(e._databaseId);return new iM(e._databaseId,!!t.ignoreUndefinedProperties,n)}/** Parse document data from a set() call. */function iF(e,t,n,r,i,s={}){let a,o;let l=e.mu(s.merge||s.mergeFields?2/* UserDataSource.MergeSet */:0/* UserDataSource.Set */,t,n,i);iK("Data must be an object, but it was:",l,r);let u=i$(r,l);if(s.merge)a=new er(l.fieldMask),o=l.fieldTransforms;else if(s.mergeFields){let e=[];for(let r of s.mergeFields){let i=iG(t,r,n);if(!l.contains(i))throw new b(_.INVALID_ARGUMENT,`Field '${i}' is specified in your field mask but missing from your input data.`);iY(e,i)||e.push(i)}a=new er(e),o=l.fieldTransforms.filter(e=>a.covers(e.field))}else a=null,o=l.fieldTransforms;return new iR(new ek(u),a,o)}class iV extends iD{_toFieldTransform(e){if(2/* UserDataSource.MergeSet */!==e.lu)throw 1/* UserDataSource.Update */===e.lu?e.Au(`${this._methodName}() can only appear at the top level of your update data`):e.Au(`${this._methodName}() cannot be used with set() unless you pass {merge:true}`);// No transform to add for a delete, but we need to add it to our
// fieldMask so it gets deleted.
return e.fieldMask.push(e.path),null}isEqual(e){return e instanceof iV}}class iU extends iD{_toFieldTransform(e){return new tA(e.path,new tv)}isEqual(e){return e instanceof iU}}/** Parse update data from an update() call. */function iB(e,t,n,r){let i=e.mu(1/* UserDataSource.Update */,t,n);iK("Data must be an object, but it was:",i,r);let s=[],a=ek.empty();Y(r,(e,r)=>{let o=iQ(t,e,n);// For Compat types, we have to "extract" the underlying types before
// performing validation.
r=(0,u.getModularInstance)(r);let l=i.Eu(o);if(r instanceof iV)s.push(o);else{let e=ij(r,l);null!=e&&(s.push(o),a.set(o,e))}});let o=new er(s);return new ix(a,o,i.fieldTransforms)}/** Parse update data from a list of field/value arguments. */function iq(e,t,n,r,i,s){let a=e.mu(1/* UserDataSource.Update */,t,n),o=[iG(t,r,n)],l=[i];if(s.length%2!=0)throw new b(_.INVALID_ARGUMENT,`Function ${t}() needs to be called with an even number of arguments that alternate between field names and values.`);for(let e=0;e<s.length;e+=2)o.push(iG(t,s[e])),l.push(s[e+1]);let h=[],c=ek.empty();// We iterate in reverse order to pick the last value for a field if the
// user specified the field multiple times.
for(let e=o.length-1;e>=0;--e)if(!iY(h,o[e])){let t=o[e],n=l[e];// For Compat types, we have to "extract" the underlying types before
// performing validation.
n=(0,u.getModularInstance)(n);let r=a.Eu(t);if(n instanceof iV)h.push(t);else{let e=ij(n,r);null!=e&&(h.push(t),c.set(t,e))}}let d=new er(h);return new ix(c,d,a.fieldTransforms)}/**
...
if(t.settings.Iu&&4/* UserDataSource.ArrayArgument */!==t.lu)throw t.Au("Nested arrays are not supported");return function(e,t){let n=[],r=0;for(let i of e){let e=ij(i,t.du(r));null==e&&// Just include nulls in the array for fields being replaced with a
// sentinel.
...
let n=new M(e.seconds,1e3*Math.floor(e.nanoseconds/1e3));return{timestampValue:nt(t.serializer,n)}}if(e instanceof iN)return{geoPointValue:{latitude:e.latitude,longitude:e.longitude}};if(e instanceof iA)return{bytesValue:nn(t.serializer,e._byteString)};if(e instanceof iy){let n=t.databaseId,r=e.firestore._databaseId;if(!r.isEqual(n))throw t.Au(`Document reference is for database ${r.projectId}/${r.database} but should be for database ${n.projectId}/${n.database}`);return{referenceValue:ni(e.firestore._databaseId||t.databaseId,e._key.path)}}throw t.Au(`Unsupported field value: ${ic(e)}`)}(e,t)}function i$(e,t){let n={};return X(e)?// mask to ensure that the server creates a map entry.
t.path&&t.path.length>0&&t.fieldMask.push(t.path):Y(e,(e,r)=>{let i=ij(r,t.Pu(e));null!=i&&(n[e]=i)}),{mapValue:{fields:n}}}function iz(e){return!("object"!=typeof e||null===e||e instanceof Array||e instanceof Date||e instanceof M||e instanceof iN||e instanceof iA||e instanceof iy||e instanceof iD)}function iK(e,t,n){if(!iz(n)||!("object"==typeof n&&null!==n&&(Object.getPrototypeOf(n)===Object.prototype||null===Object.getPrototypeOf(n)))){let r=ic(n);throw"an object"===r?t.Au(e+" a custom object"):t.Au(e+" "+r)}}/**
 * Helper that calls fromDotSeparatedString() but wraps any error thrown.
 */function iG(e,t,n){if(// FieldPath.
(t=(0,u.getModularInstance)(t))instanceof iC)return t._internalPath;if("string"==typeof t)return iQ(e,t);throw iW("Field path arguments must be of type string or ",e,/* hasConverter= */!1,/* path= */void 0,n)}/**
 ...
 * evaluated.
 */function iQ(e,t,n){if(t.search(iH)>=0)throw iW(`Invalid field path (${t}). Paths must not contain '~', '*', '/', '[', or ']'`,e,/* hasConverter= */!1,/* path= */void 0,n);try{return new iC(...t.split("."))._internalPath}catch(r){throw iW(`Invalid field path (${t}). Paths must not be empty, begin with '.', end with '.', or contain '..'`,e,/* hasConverter= */!1,/* path= */void 0,n)}}function iW(e,t,n,r,i){let s=r&&!r.isEmpty(),a=void 0!==i,o=`Function ${t}() called with invalid data`;n&&(o+=" (via `toFirestore()`)"),o+=". ";let l="";return(s||a)&&(l+=" (found",s&&(l+=` in field ${r}`),a&&(l+=` in document ${i}`),l+=")"),new b(_.INVALID_ARGUMENT,o+e+l)}/** Checks `haystack` if FieldPath `needle` is present. Runs in O(n). */function iY(e,t){return e.some(e=>e.isEqual(t))}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 */class i1 extends i0{}function i2(e,t,...n){let r=[];for(let i of(t instanceof i0&&r.push(t),function(e){let t=e.filter(e=>e instanceof i6).length,n=e.filter(e=>e instanceof i9).length;if(t>1||t>0&&n>0)throw new b(_.INVALID_ARGUMENT,"InvalidQuery. When using composite filters, you cannot use more than one filter at the top level. Consider nesting the multiple filters within an `and(...)` statement. For example: change `query(query, where(...), or(...))` to `query(query, and(where(...), or(...)))`.")}(r=r.concat(n)),r))e=i._apply(e);return e}/**
 ...
 */class i9 extends i1{/**
     * @internal
     */constructor(e,t,n){super(),this._field=e,this._op=t,this._value=n,/** The type of this query constraint */this.type="where"}static _create(e,t,n){return new i9(e,t,n)}_apply(e){let t=this._parse(e);return se(e._query,t),new im(e.firestore,e.converter,e3(e._query,t))}_parse(e){let t=iP(e.firestore),n=function(e,t,n,r,i,s,a){let o;if(i.isKeyField()){if("array-contains"/* Operator.ARRAY_CONTAINS */===s||"array-contains-any"/* Operator.ARRAY_CONTAINS_ANY */===s)throw new b(_.INVALID_ARGUMENT,`Invalid Query. You can't perform '${s}' queries on documentId().`);if("in"/* Operator.IN */===s||"not-in"/* Operator.NOT_IN */===s){i8(a,s);let t=[];for(let n of a)t.push(i7(r,e,n));o={arrayValue:{values:t}}}else o=i7(r,e,a)}else"in"/* Operator.IN */!==s&&"not-in"/* Operator.NOT_IN */!==s&&"array-contains-any"/* Operator.ARRAY_CONTAINS_ANY */!==s||i8(a,s),o=/**
 * Parse a "query value" (e.g. value in a where filter or a value in a cursor
 * bound).
 *
 * @param allowArrays - Whether the query value is an array that may directly
 * contain additional arrays (e.g. the operand of an `in` query).
 */function(e,t,n,r=!1){return ij(n,e.mu(r?4/* UserDataSource.ArrayArgument */:3/* UserDataSource.Argument */,t))}(n,t,a,/* allowArrays= */"in"/* Operator.IN */===s||"not-in"/* Operator.NOT_IN */===s);return eF.create(i,s,o)}(e._query,"where",t,e.firestore._databaseId,this._field,this._op,this._value);return n}}/**
 ...
 */function i4(e,t,n){let r=iZ("where",e);return i9._create(r,t,n)}/**
 ...
 */class i5 extends i1{/**
     * @internal
     */constructor(e,t){super(),this._field=e,this._direction=t,/** The type of this query constraint */this.type="orderBy"}static _create(e,t){return new i5(e,t)}_apply(e){let t=function(e,t,n){if(null!==e.startAt)throw new b(_.INVALID_ARGUMENT,"Invalid query. You must not call startAt() or startAfter() before calling orderBy().");if(null!==e.endAt)throw new b(_.INVALID_ARGUMENT,"Invalid query. You must not call endAt() or endBefore() before calling orderBy().");let r=new eM(t,n);return function(e,t){if(null===e2(e)){// This is the first order by. It must match any inequality.
let n=e9(e);null!==n&&st(e,n,t.field)}}(e,r),r}(e._query,this._field,this._direction);return new im(e.firestore,e.converter,function(e,t){// TODO(dimond): validate that orderBy does not list the same key twice.
 ...
 */function i3(e,t="asc"){let n=iZ("orderBy",e);return i5._create(n,t)}function i7(e,t,n){if("string"==typeof(n=(0,u.getModularInstance)(n))){if(""===n)throw new b(_.INVALID_ARGUMENT,"Invalid query. When querying with documentId(), you must provide a valid document ID, but it was an empty string.");if(!e4(t)&&-1!==n.indexOf("/"))throw new b(_.INVALID_ARGUMENT,`Invalid query. When querying a collection by documentId(), you must provide a plain document ID, but '${n}' contains a '/' character.`);let r=t.path.child(V.fromString(n));if(!q.isDocumentKey(r))throw new b(_.INVALID_ARGUMENT,`Invalid query. When querying a collection group by documentId(), the value provided must result in a valid document path, but '${r}' is not because it has an odd number of segments (${r.length}).`);return eb(e,new q(r))}if(n instanceof iy)return eb(e,n._key);throw new b(_.INVALID_ARGUMENT,`Invalid query. When querying with documentId(), you must provide a valid string or a DocumentReference, but it was: ${ic(n)}.`)}/**
 ...
 * call.
 */function sr(e,t,n){// Cast to `any` in order to satisfy the union type constraint on
// toFirestore().
// eslint-disable-next-line @typescript-eslint/no-explicit-any
 ...
 * access will return 'undefined'. You can use the `exists()` method to
 * explicitly verify a document's existence.
 */class ss extends iX{/** @hideconstructor protected */constructor(e,t,n,r,i,s){super(e,t,n,r,s),this._firestore=e,this._firestoreImpl=e,this.metadata=i}/**
 ...
 * properties.
 */class so{/** @hideconstructor */constructor(e,t,n,r){this._firestore=e,this._userDataWriter=t,this._snapshot=r,this.metadata=new si(r.hasPendingWrites,r.fromCache),this.query=n}/** An array of all the documents in the `QuerySnapshot`. */get docs(){let e=[];return this.forEach(t=>e.push(t)),e}/** The number of documents in the `QuerySnapshot`. */get size(){return this._snapshot.docs.size}/** True if there are no documents in the `QuerySnapshot`. */get empty(){return 0===this.size}/**
     * Enumerates all of the documents in the `QuerySnapshot`.
     *
     * @param callback - A callback to be called with a `QueryDocumentSnapshot` for
     * each document in the snapshot.
     * @param thisArg - The `this` binding for the callback.
     */forEach(e,t){this._snapshot.docs.forEach(n=>{e.call(t,new sa(this._firestore,this._userDataWriter,n.key,n,new si(this._snapshot.mutatedKeys.has(n.key),this._snapshot.fromCache),this.query.converter))})}/**
 ...
 */function sl(e){e=id(e,iy);let t=id(e.firestore,ib);return(function(e,t,n={}){let r=new T;return e.asyncQueue.enqueueAndForget(async()=>(function(e,t,n,r,i){var s;let a=new r7({next:s=>{// Remove query first before passing event to user to avoid
    // user actions affecting the now stale query.
    t.enqueueAndForget(()=>rR(e,o));let a=s.docs.has(n);!a&&s.fromCache?// exist then we resolve with a doc.exists set to false. If
    // we're offline however, we reject the Promise in this
    // case. Two options: 1) Cache the negative response from
    // the server so we can deliver that even when you're
    // offline 2) Actually reject the Promise in the online case
    // if the document doesn't exist.
    i.reject(new b(_.UNAVAILABLE,"Failed to get document because the client is offline.")):a&&s.fromCache&&r&&"server"===r.source?i.reject(new b(_.UNAVAILABLE,'Failed to get document from server. (However, this document does exist in the local cache. Run again without setting source to "server" to retrieve the cached document.)')):i.resolve(s)},error:e=>i.reject(e)}),o=new rM((s=n.path,new e0(s)),a,{includeMetadataChanges:!0,z_:!0});return rk(e,o)})(await is(e),e.asyncQueue,t,n,r)),r.promise})(iI(t),e._key).then(n=>/**
 * Converts a {@link ViewSnapshot} that contains the single document specified by `ref`
 * to a {@link DocumentSnapshot}.
 */(function(e,t,n){let r=n.docs.get(t._key),i=new su(e);return new ss(e,i,t._key,r,new si(n.hasPendingWrites,n.fromCache),t.converter)})(t,e,n))}class su extends sn{constructor(e){super(),this.firestore=e}convertBytes(e){return new iA(e)}convertReference(e){let t=this.convertDocumentKey(e,this.firestore._databaseId);return new iy(this.firestore,/* converter= */null,t)}}/**
 ...
 */function sh(e){e=id(e,im);let t=id(e.firestore,ib),n=iI(t),r=new su(t);return(/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 */function(e){if("L"/* LimitType.Last */===e.limitType&&0===e.explicitOrderBy.length)throw new b(_.UNIMPLEMENTED,"limitToLast() queries require specifying at least one orderBy() clause")}(e._query),(function(e,t,n={}){let r=new T;return e.asyncQueue.enqueueAndForget(async()=>(function(e,t,n,r,i){let s=new r7({next:n=>{// Remove query first before passing event to user to avoid
    // user actions affecting the now stale query.
    t.enqueueAndForget(()=>rR(e,a)),n.fromCache&&"server"===r.source?i.reject(new b(_.UNAVAILABLE,'Failed to get documents from server. (However, these documents may exist in the local cache. Run again without setting source to "server" to retrieve the cached documents.)')):i.resolve(n)},error:e=>i.reject(e)}),a=new rM(n,s,{includeMetadataChanges:!0,z_:!0});return rk(e,a)})(await is(e),e.asyncQueue,t,n,r)),r.promise})(n,e._query).then(n=>new so(t,r,e,n)))}function sc(e,t,n){e=id(e,iy);let r=id(e.firestore,ib),i=sr(e.converter,t,n);return sf(r,[iF(iP(r),"setDoc",e._key,i,null!==e.converter,n).toMutation(e._key,tD.none())])}function sd(e,t,n,...r){e=id(e,iy);let i=id(e.firestore,ib),s=iP(i);return sf(i,[("string"==typeof// performing validation.
(t=(0,u.getModularInstance)(t))||t instanceof iC?iq(s,"updateDoc",e._key,t,n,r):iB(s,"updateDoc",e._key,t)).toMutation(e._key,tD.exists(!0))])}/**
 * Locally writes `mutations` on the async queue.
 * @internal
 */function sf(e,t){return function(e,t){let n=new T;return e.asyncQueue.enqueueAndForget(async()=>rK(await ii(e).then(e=>e.syncEngine),t,n)),n.promise}(iI(e),t)}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * called.
 */class sp{/** @hideconstructor */constructor(e,t){this._firestore=e,this._commitHandler=t,this._mutations=[],this._committed=!1,this._dataReader=iP(e)}set(e,t,n){this._verifyNotCommitted();let r=sg(e,this._firestore),i=sr(r.converter,t,n),s=iF(this._dataReader,"WriteBatch.set",r._key,i,null!==r.converter,n);return this._mutations.push(s.toMutation(r._key,tD.none())),this}update(e,t,n,...r){let i;this._verifyNotCommitted();let s=sg(e,this._firestore);return i="string"==typeof(t=(0,u.getModularInstance)(t))||t instanceof iC?iq(this._dataReader,"WriteBatch.update",s._key,t,n,r):iB(this._dataReader,"WriteBatch.update",s._key,t),this._mutations.push(i.toMutation(s._key,tD.exists(!0))),this}/**
     * Deletes the document referred to by the provided {@link DocumentReference}.
     *
     * @param documentRef - A reference to the document to be deleted.
     * @returns This `WriteBatch` instance. Used for chaining method calls.
     */delete(e){this._verifyNotCommitted();let t=sg(e,this._firestore);return this._mutations=this._mutations.concat(new tU(t._key,tD.none())),this}/**
     ...
     */commit(){return this._verifyNotCommitted(),this._committed=!0,this._mutations.length>0?this._commitHandler(this._mutations):Promise.resolve()}_verifyNotCommitted(){if(this._committed)throw new b(_.FAILED_PRECONDITION,"A write batch can no longer be used after commit() has been called.")}}function sg(e,t){if((e=(0,u.getModularInstance)(e)).firestore!==t)throw new b(_.INVALID_ARGUMENT,"Provided document reference is from a different Firestore instance.");return e}/**
 * Returns a sentinel used with {@link @firebase/firestore/lite#(setDoc:1)} or {@link @firebase/firestore/lite#(updateDoc:1)} to
 * include a server-generated timestamp in the written data.
 */function sm(){return new iU("serverTimestamp")}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
